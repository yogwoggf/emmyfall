...
_G.hook = {}
	...
	--- remove - shared - libs_sh/hook.lua#L801
	---@param hookname string The hook name
...
_G.wire.ports = {
	...
	--- triggerCell - server - libs_sv/wire.lua#L708
	...
	--- triggerOutput - server - libs_sv/wire.lua#L697
	---@param ent Entity Entity with output
	---@param outputname string Output name
	...
	--- readCell - server - libs_sv/wire.lua#L742
	---@param ent Entity Entity with wire memory
	---@param index number The cell address
	...
	--- readInput - server - libs_sv/wire.lua#L720
	---@param ent Entity Entity with input
	...
	--- triggerInput - server - libs_sv/wire.lua#L686
	---@param ent Entity Entity with input
	---@param inputname string Input name
...
_G.file = {}
	--- exists - client - libs_cl/file.lua#L329
	...
	--- find - client - libs_cl/file.lua#L418
	...
	--- write - client - libs_cl/file.lua#L250
	---@param path string Filepath relative to data/sf_filedata/.
	---@param data string The data to write
	function _G.file.write(path, data) end
	--- readInGame - client - libs_cl/file.lua#L220
	...
	--- read - client - libs_cl/file.lua#L211
	---@param path string Filepath relative to data/sf_filedata/.
	---@return string? undefined Contents, or nil if error
	function _G.file.read(path) end
	--- writeTemp - client - libs_cl/file.lua#L279
	...
	--- existsTemp - client - libs_cl/file.lua#L299
...
_G.nextbot = {}
	...
	---@return number undefined Number how many ragdoll can be spawned.
	...
	---@return boolean undefined True if user can spawn nextbots ragdolls, False if not.
...
---@type any
_G["CLIENT"] = nil
	--- localToWorld - shared - libs_sh/builtins.lua#L1204
	...
	--- version - shared - libs_sh/builtins.lua#L273
	---@return string undefined Starfall version
	function _G.version() end
	--- assert - shared - libs_sh/builtins.lua#L1165
	...
	--- tonumber - shared - libs_sh/builtins.lua#L107
	...
	--- throw - shared - libs_sh/builtins.lua#L1148
	...
	--- rawget - shared - libs_sh/builtins.lua#L462
	...
	--- ramUsed - shared - libs_sh/builtins.lua#L255
	...
	--- getScript - shared - libs_sh/builtins.lua#L781
	...
	--- rawset - shared - libs_sh/builtins.lua#L453
	...
	--- hasPermission - shared - libs_sh/builtins.lua#L317
	...
	--- permissionRequestSatisfied - client - libs_sh/builtins.lua#L368
	...
	--- shareScripts - shared - libs_sh/builtins.lua#L816
	---@param enable boolean If true, allow sharing scripts
	function _G.shareScripts(enable) end
	--- ramAverage - shared - libs_sh/builtins.lua#L261
	---@return number undefined The ram used in kilobytes
	function _G.ramAverage() end
	--- xpcall - shared - libs_sh/builtins.lua#L1099
	...
	--- class - shared - libs_sh/builtins.lua#L1267
	...
	--- enableHud - shared - libs_sh/builtins.lua#L1223
	...
	--- worldToLocal - shared - libs_sh/builtins.lua#L1185
	...
	--- dodir - shared - libs_sh/builtins.lua#L893
	...
	--- error - shared - libs_sh/builtins.lua#L1156
	---@param msg string Message string
	...
	--- try - shared - libs_sh/builtins.lua#L1127
	...
	--- loadstring - shared - libs_sh/builtins.lua#L934
	...
	--- owner - shared - libs_sh/builtins.lua#L63
	...
	--- printHud - shared - libs_sh/builtins.lua#L584
	...
	--- unpack - shared - libs_sh/builtins.lua#L151
	...
	--- setSoftQuota - shared - libs_sh/builtins.lua#L310
	...
	--- sendPermissionRequest - client - libs_sh/builtins.lua#L376
	function _G.sendPermissionRequest() end
	--- setupPermissionRequest - client - libs_sh/builtins.lua#L335
	...
	--- select - shared - libs_sh/builtins.lua#L92
	---@param parameter any 
...
_G.debug = {}
	--- traceback - shared - libs_sh/builtins.lua#L1004
	...
	--- getlocal - shared - libs_sh/builtins.lua#L1047
	...
	--- getinfo - shared - libs_sh/builtins.lua#L1031
	---@param funcOrStackLevel function|number Function or stack level to get info about. Defaults to stack level 0.
...
_G.navmesh.NAV_TRAVERSE_TYPE = {
	...
	--- find - server - libs_sv/navmesh.lua#L181
	...
	--- getNavAreaCount - server - libs_sv/navmesh.lua#L203
	...
	--- getGetEditCursorPosition - server - libs_sv/navmesh.lua#L239
	---@return Vector undefined The position of the edit cursor.
	function _G.navmesh.getGetEditCursorPosition() end
	--- getNearestNavArea - server - libs_sv/navmesh.lua#L227
	...
	--- getNavAreaByID - server - libs_sv/navmesh.lua#L210
	...
	--- getNavArea - server - libs_sv/navmesh.lua#L218
	...
	--- getGroundHeight - server - libs_sv/navmesh.lua#L160
	...
	--- getAllNavAreas - server - libs_sv/navmesh.lua#L169
...
_G.os = {}
	--- difftime - shared - libs_sh/builtins.lua#L415
	...
	--- time - shared - libs_sh/builtins.lua#L422
	...
	--- clock - shared - libs_sh/builtins.lua#L396
	---@return number undefined The runtime
	function _G.os.clock() end
	--- isWindows - shared - libs_sh/builtins.lua#L429
...
_G.render.Vertex = {
	...
	--- setFogEnd - client - libs_cl/render.lua#L2691
	---@param distance number End distance
	function _G.render.setFogEnd(distance) end
	--- setRGBA - client - libs_cl/render.lua#L935
	---@param r number Number, red value
	---@param g number Number, green value
	---@param b number Number, blue value
	---@param a number Number, alpha value
	function _G.render.setRGBA(r, g, b, a) end
	--- getTintRGBA - client - libs_cl/render.lua#L959
	...
	--- clearBuffersObeyStencil - client - libs_cl/render.lua#L656
	...
	--- popViewMatrix - client - libs_cl/render.lua#L854
	function _G.render.popViewMatrix() end
	--- overrideBlend - client - libs_cl/render.lua#L1994
	...
	--- setFogHeight - client - libs_cl/render.lua#L2700
	---@param height number The fog height
	function _G.render.setFogHeight(height) end
	--- drawPixelsRGB - client - libs_cl/render.lua#L1695
	...
	--- drawTexturedRectRotatedFast - client - libs_cl/render.lua#L1638
	...
	--- drawPixelsRGBA - client - libs_cl/render.lua#L1711
	---@param w number Width of image to be drawn.
	---@param h number Height of image to be drawn.
	---@param dataR table Red channel data.
	---@param dataG table Green channel data.
	...
	--- popCustomClipPlane - client - libs_cl/render.lua#L2611
	function _G.render.popCustomClipPlane() end
	--- drawRoundedBox - client - libs_cl/render.lua#L1367
	...
	--- enableClipping - client - libs_cl/render.lua#L2580
	...
	--- draw3DBox - client - libs_cl/render.lua#L2082
	...
	--- draw3DQuadEasy - client - libs_cl/render.lua#L2149
	...
	--- add3DBeam - client - libs_cl/render.lua#L2122
	...
	--- drawRectOutline - client - libs_cl/render.lua#L1457
	...
	--- start3DBeam - client - libs_cl/render.lua#L2115
	...
	--- drawTexturedTriangleUV - client - libs_cl/render.lua#L1681
	...
	--- getResolution - client - libs_cl/render.lua#L2384
	...
	--- traceSurfaceColor - client - libs_cl/render.lua#L2407
	...
	--- setStencilPassOperation - client - libs_cl/render.lua#L696
	---@param operation number 
	function _G.render.setStencilPassOperation(operation) end
	--- drawTexturedRectRotated - client - libs_cl/render.lua#L1651
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getViewSetup - client - libs_cl/render.lua#L2319
	...
	--- getMatrix - client - libs_cl/render.lua#L793
	---@return VMatrix undefined The currently active matrix.
	function _G.render.getMatrix() end
	--- setModelLighting - client - libs_cl/render.lua#L637
	...
	--- draw3DWireframeBox - client - libs_cl/render.lua#L2092
	---@param origin Vector Origin of the box.
	---@param angle Angle Orientation of the box
	---@param mins Vector Start position of the box, relative to origin.
	---@param maxs Vector End position of the box, relative to origin.
	...
	--- draw3DWireframeSphere - client - libs_cl/render.lua#L2058
	...
	--- pushCustomClipPlane - client - libs_cl/render.lua#L2595
	...
	--- setMaterialEffectSub - client - libs_cl/render.lua#L1049
	...
	--- readPixel - client - libs_cl/render.lua#L2363
	...
	--- pushMatrix - client - libs_cl/render.lua#L752
	...
	--- depthRange - client - libs_cl/render.lua#L2786
	...
	--- destroyRenderTarget - client - libs_cl/render.lua#L1200
	---@param name string Rendertarget name
	function _G.render.destroyRenderTarget(name) end
	--- pushViewMatrix - client - libs_cl/render.lua#L808
	...
	--- getTextSize - client - libs_cl/render.lua#L1850
	...
	--- disableScissorRect - client - libs_cl/render.lua#L779
	function _G.render.disableScissorRect() end
	--- setMaterialEffectAdd - client - libs_cl/render.lua#L1035
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	function _G.render.setMaterialEffectAdd(mat) end
	--- draw3DSphere - client - libs_cl/render.lua#L2046
	---@param pos Vector Position of the sphere
	---@param radius number Radius of the sphere
	---@param longitudeSteps number The amount of longitude steps. The larger this number is, the smoother the sphere is
	---@param latitudeSteps number The amount of latitude steps. The larger this number is, the smoother the sphere is
	function _G.render.draw3DSphere(pos, radius, longitudeSteps, latitudeSteps) end
	--- setMaterialEffectBloom - client - libs_cl/render.lua#L1063
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- setFogMode - client - libs_cl/render.lua#L2655
	---@param mode number Fog mode
	function _G.render.setFogMode(mode) end
	--- clearStencil - client - libs_cl/render.lua#L616
	function _G.render.clearStencil() end
	--- draw3DQuadUV - client - libs_cl/render.lua#L2182
	...
	--- createFont - client - libs_cl/render.lua#L1785
	...
	--- isInRenderTarget - client - libs_cl/render.lua#L1213
	...
	--- getAngles - client - libs_cl/render.lua#L594
	...
	--- setFont - client - libs_cl/render.lua#L1859
	---@param font string The font to use
	function _G.render.setFont(font) end
	--- drawRectRotatedFast - client - libs_cl/render.lua#L1430
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getEyePos - client - libs_cl/render.lua#L586
	...
	--- readPixelRGBA - client - libs_cl/render.lua#L2372
	---@param x number Pixel x-coordinate.
	---@param y number Pixel y-coordinate.
	...
	--- drawTriangle - client - libs_cl/render.lua#L1531
	...
	--- parseMarkup - client - libs_cl/render.lua#L1943
	...
	--- computeLighting - client - libs_cl/render.lua#L2621
	...
	--- drawRect - client - libs_cl/render.lua#L1418
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawRect(x, y, w, h) end
	--- resetModelLighting - client - libs_cl/render.lua#L647
	...
	--- end3DBeam - client - libs_cl/render.lua#L2132
	function _G.render.end3DBeam() end
	--- renderTargetExists - client - libs_cl/render.lua#L1177
	...
	--- drawBlurEffect - client - libs_cl/render.lua#L1155
	...
	--- setStencilZFailOperation - client - libs_cl/render.lua#L704
	---@param operation number 
	function _G.render.setStencilZFailOperation(operation) end
	--- capturePixels - client - libs_cl/render.lua#L2332
	function _G.render.capturePixels() end
	--- drawSimpleTextOutlined - client - libs_cl/render.lua#L1925
	---@param x number X coordinate
	---@param y number Y coordinate
	---@param text string Text to draw
	...
	--- destroyTexture - client - libs_cl/render.lua#L999
	---@param mat Material The material object
	function _G.render.destroyTexture(mat) end
	--- draw3DBeam - client - libs_cl/render.lua#L2104
	---@param startPos Vector Beam start position.
	...
	--- setStencilEnable - client - libs_cl/render.lua#L608
	---@param enable boolean True to enable, false to disable
	function _G.render.setStencilEnable(enable) end
	--- createRenderTarget - client - libs_cl/render.lua#L1185
	---@param name string The name of the render target
	function _G.render.createRenderTarget(name) end
	--- setTint - client - libs_cl/render.lua#L971
	---@param c Color A color
	function _G.render.setTint(c) end
	--- drawPoly - client - libs_cl/render.lua#L1982
	...
	--- captureImage - client - libs_cl/render.lua#L2339
	...
	--- cursorPos - client - libs_cl/render.lua#L2261
	...
	--- clearStencilBufferRectangle - client - libs_cl/render.lua#L668
	...
	--- setMaterialEffectColorModify - client - libs_cl/render.lua#L1122
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- selectRenderTarget - client - libs_cl/render.lua#L1219
	---@param name string? Name of the render target to use
	function _G.render.selectRenderTarget(name) end
	--- setColorModulation - client - libs_cl/render.lua#L923
	---@param r number Red channel
	---@param g number Green channel
	---@param b number Blue channel
	function _G.render.setColorModulation(r, g, b) end
	--- createMaterial - client - libs_cl/render.lua#L978
	...
	--- drawTexturedRectUV - client - libs_cl/render.lua#L1609
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	...
	--- drawRectRotated - client - libs_cl/render.lua#L1443
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getEyeVector - client - libs_cl/render.lua#L600
	...
	--- popMatrix - client - libs_cl/render.lua#L785
	function _G.render.popMatrix() end
	--- computeDynamicLighting - client - libs_cl/render.lua#L2631
	---@param pos Vector Vector position to sample from
	---@param normal Vector Normal vector of the surface
	---@return Vector undefined Vector representing color of the light
	function _G.render.computeDynamicLighting(pos, normal) end
	--- getColorModulation - client - libs_cl/render.lua#L914
	...
	--- draw3DQuad - client - libs_cl/render.lua#L2138
	...
	--- enableDepth - client - libs_cl/render.lua#L1987
	---@param enable boolean True to enable
	function _G.render.enableDepth(enable) end
	--- draw3DTriangle - client - libs_cl/render.lua#L2213
	...
	--- drawTexturedRectUVFast - client - libs_cl/render.lua#L1571
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	...
	--- setStencilWriteMask - client - libs_cl/render.lua#L728
	---@param mask number The mask bitflag.
...
_G.Wirelink = {}
	...
	--- outputType - server - libs_sv/wire.lua#L817
	...
	--- isWired - server - libs_sv/wire.lua#L875
...
_G.Bass = {}
	...
	--- getBitsPerSample - client - libs_cl/bass.lua#L436
	...
	--- getFlags - client - libs_cl/bass.lua#L515
	...
	--- get3DEnabled - client - libs_cl/bass.lua#L544
	---@return boolean undefined True or False depending on if the sound is currently 3D or not.
	...
	--- getTagsMP4 - client - libs_cl/bass.lua#L487
	---@return table undefined A list of available information in no particular order, or nil if no information is available.
	...
	--- getTagsHTTP - client - libs_cl/bass.lua#L464
	...
	--- get3DCone - client - libs_cl/bass.lua#L596
...
---@class NavArea
_G.NavArea = {}
	--- getCenter - server - libs_sv/navmesh.lua#L396
	---@return Vector undefined The center vector.
	function _G.NavArea:getCenter() end
	--- getSizeX - server - libs_sv/navmesh.lua#L524
	---@return number undefined Width
	function _G.NavArea:getSizeX() end
	--- getAdjacentAreas - server - libs_sv/navmesh.lua#L343
	...
	--- isConnectedAtSide - server - libs_sv/navmesh.lua#L301
	...
	--- setParent - server - libs_sv/navmesh.lua#L693
	...
	--- hasAttributes - server - libs_sv/navmesh.lua#L553
	...
	--- getParentHow - server - libs_sv/navmesh.lua#L494
	---@return number undefined 
	function _G.NavArea:getParentHow() end
	--- getCorner - server - libs_sv/navmesh.lua#L411
	...
	--- addHidingSpot - server - libs_sv/navmesh.lua#L728
	...
	--- setCorner - server - libs_sv/navmesh.lua#L678
	...
	--- getIncomingConnections - server - libs_sv/navmesh.lua#L458
	...
	--- isVisible - server - libs_sv/navmesh.lua#L632
	---@param pos Vector The position to check.
	...
	--- getID - server - libs_sv/navmesh.lua#L451
	---@return number undefined The unique ID.
	function _G.NavArea:getID() end
	--- isBlocked - server - libs_sv/navmesh.lua#L562
	...
	--- isUnderwater - server - libs_sv/navmesh.lua#L270
	---@return boolean undefined Whether we're underwater or not.
	function _G.NavArea:isUnderwater() end
	--- isOverlappingArea - server - libs_sv/navmesh.lua#L600
	...
	--- getExposedSpots - server - libs_sv/navmesh.lua#L427
	---@return table undefined A table of Vectors
	function _G.NavArea:getExposedSpots() end
	--- isPotentiallyVisible - server - libs_sv/navmesh.lua#L617
	---@param area NavArea The area to test.
	...
	--- getZ - server - libs_sv/navmesh.lua#L545
	...
	--- isCoplanar - server - libs_sv/navmesh.lua#L311
	...
	--- getAdjacentCount - server - libs_sv/navmesh.lua#L371
	...
	--- computeAdjacentConnectionHeightChange - server - libs_sv/navmesh.lua#L335
	---@param other NavArea The nav area to test against.
	---@return number undefined The height change
	function _G.NavArea:computeAdjacentConnectionHeightChange(other) end
	--- isOverlapping - server - libs_sv/navmesh.lua#L589
	...
	--- isPartiallyVisible - server - libs_sv/navmesh.lua#L608
	---@param pos Vector The position to test.
	...
	--- getAdjacentAreasAtSide - server - libs_sv/navmesh.lua#L356
	...
	--- getAdjacentCountAtSide - server - libs_sv/navmesh.lua#L379
	---@param navDir number The direction, in which to look for CNavAreas, see NAV_DIR enums.
	...
	--- getSizeY - server - libs_sv/navmesh.lua#L531
	---@return number undefined Height
	function _G.NavArea:getSizeY() end
	--- getCostSoFar - server - libs_sv/navmesh.lua#L420
...
---@operator tostring:string
_G.Entity = {}
	--- localToWorld - shared - libs_sh/entities.lua#L1520
	...
	--- obbMins - shared - libs_sh/entities.lua#L1412
	---@return Vector undefined The min bounding box vector
	function _G.Entity:obbMins() end
	--- getNWVar - shared - libs_sh/entities.lua#L2182
	...
	--- getHitBoxBounds - shared - libs_sh/entities.lua#L2019
	...
	--- getVelocity - shared - libs_sh/entities.lua#L1486
	...
	--- getModelContents - shared - libs_sh/entities.lua#L1847
	...
	--- getBrushPlaneCount - shared - libs_sh/entities.lua#L2105
	...
	--- setPersistent - shared - libs_sh/entities.lua#L1994
	---@param persist boolean True to make persistent
	function _G.Entity:setPersistent(persist) end
	--- mapCreationID - shared - libs_sh/entities.lua#L2245
	...
	--- getLocalPos - shared - libs_sh/entities.lua#L1236
	---@return Vector undefined The position vector
	function _G.Entity:getLocalPos() end
	--- getDTBool - shared - libs_sh/entities.lua#L2122
	...
	--- getManipulateBonePosition - shared - libs_sh/entities.lua#L1371
	...
	--- getMatrix - shared - libs_sh/entities.lua#L1309
	---@return VMatrix undefined The matrix
	function _G.Entity:getMatrix() end
	--- entOwner - shared - libs_sh/entities.lua#L2011
	---@return Entity undefined Owner
	function _G.Entity:entOwner() end
	--- getDTString - shared - libs_sh/entities.lua#L2162
	---@param key number The number key. Valid keys are 0 - 31
	...
	--- getRight - shared - libs_sh/entities.lua#L1964
	---@return Vector undefined Vector right
	function _G.Entity:getRight() end
	--- lookupSequence - shared - libs_sh/entities.lua#L1580
	...
	--- getModelScale - shared - libs_sh/entities.lua#L1861
	---@return number undefined Scale of the model
	function _G.Entity:getModelScale() end
	--- getLocalVelocity - shared - libs_sh/entities.lua#L1493
	...
	--- getLocalAngles - shared - libs_sh/entities.lua#L1461
	...
	--- getBoneCount - shared - libs_sh/entities.lua#L1316
	...
	--- getSequence - shared - libs_sh/entities.lua#L1588
	...
	--- getAngles - shared - libs_sh/entities.lua#L1454
	---@return Angle undefined The angle
	...
	--- getFlexes - shared - libs_sh/entities.lua#L1694
	...
	--- getEyePos - shared - libs_sh/entities.lua#L1920
	...
	--- getBrushSurfaces - shared - libs_sh/entities.lua#L2080
	...
	--- getNWVarTable - shared - libs_sh/entities.lua#L2194
	---@return table undefined The table of networked objects
	function _G.Entity:getNWVarTable() end
	--- worldToLocal - shared - libs_sh/entities.lua#L1564
	...
	--- getBoneMatrix - shared - libs_sh/entities.lua#L1259
	---@param bone number? Bone index. (def 0)
	---@return VMatrix undefined The matrix
	function _G.Entity:getBoneMatrix(bone) end
	--- getPose - shared - libs_sh/entities.lua#L1659
	...
	--- getEffectModel - shared - libs_sh/entities.lua#L1824
	...
	--- setBoneMatrix - client - libs_sh/entities.lua#L1270
	...
	--- getBrushPlane - shared - libs_sh/entities.lua#L2093
	...
	--- getRotatedAABB - shared - libs_sh/entities.lua#L1888
	...
	--- getCollisionBounds - shared - libs_sh/entities.lua#L1878
	...
	--- sequenceDuration - shared - libs_sh/entities.lua#L1639
	...
	--- getChipAuthor - shared - libs_sh/entities.lua#L1083
	...
	--- isSequenceFinished - shared - libs_sh/entities.lua#L1633
	...
	--- getHitBoxHitGroup - shared - libs_sh/entities.lua#L2069
	...
	--- getNetworkVars - shared - libs_sh/entities.lua#L2252
	...
	--- worldToLocalVector - shared - libs_sh/entities.lua#L1537
	...
	--- getAngleVelocity - shared - libs_sh/entities.lua#L1501
	...
	--- getMaxHealth - shared - libs_sh/entities.lua#L1899
	---@return number undefined Max Health of the entity
	function _G.Entity:getMaxHealth() end
	--- obbCenter - shared - libs_sh/entities.lua#L1397
	---@return Vector undefined The position vector of the outer bounding box center
	function _G.Entity:obbCenter() end
	--- getEyeAngles - shared - libs_sh/entities.lua#L1913
	...
	--- getHitBoxBone - shared - libs_sh/entities.lua#L2043
	---@param hitbox number The number of the hitbox.
	---@param group number The number of the hitbox group, 0 in most cases.
	...
	--- getForward - shared - libs_sh/entities.lua#L1971
	...
	--- getCreationTime - shared - libs_sh/entities.lua#L1978
	...
	--- getHitBoxSet - shared - libs_sh/entities.lua#L2054
	...
	--- getPoseRange - shared - libs_sh/entities.lua#L1686
	...
	--- getBonePosition - shared - libs_sh/entities.lua#L1341
	---@param bone number? Bone index. (def 0)
	...
	--- getInternalVariable - shared - libs_sh/entities.lua#L2235
	...
	--- getSequenceCount - shared - libs_sh/entities.lua#L1621
	...
	--- getUp - shared - libs_sh/entities.lua#L1957
	...
	--- getHitBoxCount - shared - libs_sh/entities.lua#L2034
	...
	--- getSequenceInfo - shared - libs_sh/entities.lua#L1602
	...
	--- hasFlexManipulations - shared - libs_sh/entities.lua#L1721
	...
	--- localToWorldAngles - shared - libs_sh/entities.lua#L1556
	...
	--- getModel - shared - libs_sh/entities.lua#L1817
	---@return string undefined Model of the entity
	function _G.Entity:getModel() end
	--- getSaveTable - shared - libs_sh/entities.lua#L2226
	...
	--- getHitBoxSetCount - shared - libs_sh/entities.lua#L2062
	---@return number undefined Number of hitbox sets.
	function _G.Entity:getHitBoxSetCount() end
	--- getModelBounds - shared - libs_sh/entities.lua#L1837
	...
	--- getNearestPoint - shared - libs_sh/entities.lua#L2217
	...
	--- localToWorldVector - shared - libs_sh/entities.lua#L1529
	...
	--- setMaxHealth - server - libs_sh/entities.lua#L1183
	...
	--- getMaterial - shared - libs_sh/entities.lua#L1932
	...
	--- getWirelink - server - libs_sv/wire.lua#L753
	---@return Wirelink undefined Wirelink of the entity
	function _G.Entity:getWirelink() end
	--- getSequenceList - shared - libs_sh/entities.lua#L1615
	...
	--- setupBones - client - libs_sh/entities.lua#L1302
	...
	--- entIndex - shared - libs_sh/entities.lua#L1208
	---@return number undefined The numerical index of the entity
	function _G.Entity:entIndex() end
	--- getPos - shared - libs_sh/entities.lua#L1229
	---@return Vector undefined The position vector
	function _G.Entity:getPos() end
	--- getManipulateBoneJiggle - shared - libs_sh/entities.lua#L1362
	---@param bone number? Bone index. (def 0)
	...
	--- getBoneName - shared - libs_sh/entities.lua#L1323
	---@param bone number? Bone index. (def 0)
	...
	--- doNotDuplicate - server - libs_sh/entities.lua#L1193
	...
	--- getDTFloat - shared - libs_sh/entities.lua#L2142
	---@param key number The number key. Valid keys are 0 - 31
	...
	--- obbSize - shared - libs_sh/entities.lua#L1389
	...
	--- worldSpaceAABB - shared - libs_sh/entities.lua#L1426
	---@return Vector undefined The min bounding box vector
	...
	--- getWaterLevel - shared - libs_sh/entities.lua#L1243
	...
	--- getPoseName - shared - libs_sh/entities.lua#L1679
	---@param id number Pose index (starting from 0)
	...
	--- getManipulateBoneAngles - shared - libs_sh/entities.lua#L1353
	---@param bone number Bone index. (def 0)
	...
	--- obbMaxs - shared - libs_sh/entities.lua#L1419
	---@return Vector undefined The max bounding box vector
	...
	--- getMass - shared - libs_sh/entities.lua#L1468
	---@return number undefined The numerical mass
	function _G.Entity:getMass() end
	--- getAngleVelocityAngle - shared - libs_sh/entities.lua#L1510
	...
	--- worldToLocalAngles - shared - libs_sh/entities.lua#L1572
	...
	--- getSequenceName - shared - libs_sh/entities.lua#L1594
	---@param id number The id of the animation
	---@return string undefined The sequence name
	function _G.Entity:getSequenceName(id) end
	--- getQuotaAverage - shared - libs_sh/entities.lua#L1105
	...
	--- setPose - shared - libs_sh/entities.lua#L1649
	...
	--- getModelRadius - shared - libs_sh/entities.lua#L1854
...
---@class Player
_G.Player = {}
	--- shouldDrawLocalPlayer - client - libs_sh/players.lua#L821
	...
	--- isMuted - client - libs_sh/players.lua#L529
	...
	--- isPlayingAnimation - client - libs_sh/players.lua#L791
	---@return boolean undefined If an animation is playing
	function _G.Player:isPlayingAnimation() end
	--- setAnimationRange - client - libs_sh/players.lua#L772
	...
	--- getAnimationTime - client - libs_sh/players.lua#L810
	...
	--- isPlayingTaunt - shared - libs_sh/players.lua#L514
	...
	--- voiceVolume - client - libs_sh/players.lua#L543
	...
	--- setAnimationActivity - client - libs_sh/players.lua#L663
	...
	--- setAnimationProgress - client - libs_sh/players.lua#L682
	...
	--- resetAnimation - client - libs_sh/players.lua#L654
	...
	--- getAnimationProgress - client - libs_sh/players.lua#L799
	...
	--- setAnimationBounce - client - libs_sh/players.lua#L742
	...
	--- setAnimationAutoAdvance - client - libs_sh/players.lua#L727
	...
	--- setAnimationTime - client - libs_sh/players.lua#L697
	...
	--- setAnimation - client - libs_sh/players.lua#L606
	...
	--- setAnimationLoop - client - libs_sh/players.lua#L757
	...
	--- getFriendStatus - client - libs_sh/players.lua#L521
	...
	--- resetGesture - client - libs_sh/players.lua#L580
	...
	--- playGesture - client - libs_sh/players.lua#L550
	...
	--- setGestureWeight - client - libs_sh/players.lua#L592
	---@param slot number? Optional int (Default GESTURE_SLOT.CUSTOM), the gesture slot to use. GESTURE_SLOT table values
	---@param weight number? Optional float (Default 1), the weight of the gesture. Ranging from 0-1
...
---@class Markup
_G.Markup = {}
	--- getSize - client - libs_cl/render.lua#L1975
	...
	--- draw - client - libs_cl/render.lua#L1951
	...
	--- getWidth - client - libs_cl/render.lua#L1963
	---@return number undefined The width of the object
	function _G.Markup:getWidth() end
	--- getHeight - client - libs_cl/render.lua#L1969
	---@return number undefined The height of the object
