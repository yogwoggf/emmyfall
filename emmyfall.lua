...
_G.net = {}
	...
	--- send - shared - libs_sh/net.lua#L100
	...
	--- writeMatrix - shared - libs_sh/net.lua#L444
	---@param t VMatrix The matrix to be written
	function _G.net.writeMatrix(t) end
	--- readStream - shared - libs_sh/net.lua#L245
