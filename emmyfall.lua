...
---  Input library.
_G.input = {}
	--- getAnalogValue - client - libs_sh/input.lua#L401
	...
	--- lookupKeyBinding - client - libs_sh/input.lua#L237
	...
	--- getCursorPos - client - libs_sh/input.lua#L302
