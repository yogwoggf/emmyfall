...
_G.net = {}
	--- readVector - shared - libs_sh/net.lua#L412
	...
	--- readBool - shared - libs_sh/net.lua#L342
	...
	--- writeFloat - shared - libs_sh/net.lua#L367
	---@param t number The float to be written
	function _G.net.writeFloat(t) end
	--- writeVector - shared - libs_sh/net.lua#L402
	...
	--- readAngle - shared - libs_sh/net.lua#L395
	...
	--- readEntity - shared - libs_sh/net.lua#L464
	...
	--- readColor - shared - libs_sh/net.lua#L447
	---@return Color undefined The color that was read
	function _G.net.readColor() end
	--- writeAngle - shared - libs_sh/net.lua#L385
	...
	--- writeColor - shared - libs_sh/net.lua#L439
	...
	--- writeBool - shared - libs_sh/net.lua#L331
	---@param t boolean The bit to be written.
	function _G.net.writeBool(t) end
	--- writeMatrix - shared - libs_sh/net.lua#L419
