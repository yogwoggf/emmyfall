...
_G.render.Vertex = {
	...
	--- getAngles - client - libs_cl/render.lua#L560
	...
	--- depthRange - client - libs_cl/render.lua#L2462
	...
	--- clearBuffersObeyStencil - client - libs_cl/render.lua#L622
	...
	--- screenShake - client - libs_cl/render.lua#L2453
	...
	--- getEyePos - client - libs_cl/render.lua#L552
	...
	--- setColorModulation - client - libs_cl/render.lua#L890
	---@param r number Red channel
	---@param g number Green channel
	---@param b number Blue channel
	function _G.render.setColorModulation(r, g, b) end
	--- setLightingMode - client - libs_cl/render.lua#L865
	...
	--- popViewMatrix - client - libs_cl/render.lua#L828
	function _G.render.popViewMatrix() end
	--- overrideBlend - client - libs_cl/render.lua#L1815
	...
	--- draw3DSprite - client - libs_cl/render.lua#L1856
	...
	--- getDefaultFont - client - libs_cl/render.lua#L1728
	---@return string undefined Default font
	function _G.render.getDefaultFont() end
	--- setFilterMin - client - libs_cl/render.lua#L1255
	---@param val number The filter function to use http://wiki.facepunch.com/gmod/Enums/TEXFILTER
	function _G.render.setFilterMin(val) end
	--- drawPixelsRGBA - client - libs_cl/render.lua#L1549
	---@param w number Width of image to be drawn.
	---@param h number Height of image to be drawn.
	---@param dataR table Red channel data.
	---@param dataG table Green channel data.
	...
	--- drawText - client - libs_cl/render.lua#L1734
	...
	--- drawRoundedBox - client - libs_cl/render.lua#L1288
	...
	--- drawSimpleText - client - libs_cl/render.lua#L1747
	---@param x number X coordinate
	---@param y number Y coordinate
	---@param text string Text to draw
	...
	--- draw3DBox - client - libs_cl/render.lua#L1907
	...
	--- setFogMode - client - libs_cl/render.lua#L2351
	...
	--- drawRoundedBoxEx - client - libs_cl/render.lua#L1299
	---@param r number The corner radius
	---@param x number Top left corner x coordinate
	---@param y number Top left corner y coordinate
	---@param w number Width
	...
	--- computeDynamicLighting - client - libs_cl/render.lua#L2330
	...
	--- computeLighting - client - libs_cl/render.lua#L2322
	---@param pos Vector Vector position to sample from
	---@param normal Vector Normal vector of the surface
	---@return Vector undefined Vector representing color of the light
	function _G.render.computeLighting(pos, normal) end
	--- popCustomClipPlane - client - libs_cl/render.lua#L2312
	function _G.render.popCustomClipPlane() end
	--- pushCustomClipPlane - client - libs_cl/render.lua#L2297
	...
	--- drawRectOutline - client - libs_cl/render.lua#L1349
	...
	--- parseMarkup - client - libs_cl/render.lua#L1763
	...
	--- drawTexturedRectUV - client - libs_cl/render.lua#L1445
	...
	--- createRenderTarget - client - libs_cl/render.lua#L1127
	---@param name string The name of the render target
	function _G.render.createRenderTarget(name) end
	--- drawRect - client - libs_cl/render.lua#L1337
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawRect(x, y, w, h) end
	--- resetModelLighting - client - libs_cl/render.lua#L613
	...
	--- clear - client - libs_cl/render.lua#L1274
	...
	--- getBlend - client - libs_cl/render.lua#L1834
	---@return number undefined Blending in the range 0 to 1
	function _G.render.getBlend() end
	--- getColorModulation - client - libs_cl/render.lua#L881
	...
	--- getMatrix - client - libs_cl/render.lua#L767
	---@return VMatrix undefined The currently active matrix.
	function _G.render.getMatrix() end
	--- setModelLighting - client - libs_cl/render.lua#L603
	...
	--- draw3DWireframeSphere - client - libs_cl/render.lua#L1879
	...
	--- drawRectFast - client - libs_cl/render.lua#L1326
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawRectFast(x, y, w, h) end
	--- setMaterialEffectColorModify - client - libs_cl/render.lua#L1065
	...
	--- resetStencil - client - libs_cl/render.lua#L702
	function _G.render.resetStencil() end
	--- drawTexturedRect - client - libs_cl/render.lua#L1410
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawTexturedRect(x, y, w, h) end
	--- setScreenDimensions - client - libs_cl/render.lua#L2427
	...
	--- getGameResolution - client - libs_cl/render.lua#L2112
	...
	--- cursorPos - client - libs_cl/render.lua#L1999
	...
	--- setStencilTestMask - client - libs_cl/render.lua#L686
	---@param mask number The mask bitflag.
	function _G.render.setStencilTestMask(mask) end
	--- draw3DQuad - client - libs_cl/render.lua#L1953
	...
	--- setBackgroundColor - client - libs_cl/render.lua#L841
	...
	--- setStencilZFailOperation - client - libs_cl/render.lua#L670
	---@param operation number 
	function _G.render.setStencilZFailOperation(operation) end
	--- capturePixels - client - libs_cl/render.lua#L2059
	function _G.render.capturePixels() end
	--- drawTexturedRectFast - client - libs_cl/render.lua#L1399
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawTexturedRectFast(x, y, w, h) end
	--- clearStencilBufferRectangle - client - libs_cl/render.lua#L634
	...
	--- draw3DBeam - client - libs_cl/render.lua#L1939
	...
	--- setStencilEnable - client - libs_cl/render.lua#L574
	---@param enable boolean True to enable, false to disable
	function _G.render.setStencilEnable(enable) end
	--- setMaterialEffectSub - client - libs_cl/render.lua#L992
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	function _G.render.setMaterialEffectSub(mat) end
	--- setFont - client - libs_cl/render.lua#L1697
	---@param font string The font to use
	function _G.render.setFont(font) end
	--- drawPoly - client - libs_cl/render.lua#L1802
	...
	--- captureImage - client - libs_cl/render.lua#L2066
	...
	--- readPixel - client - libs_cl/render.lua#L2090
	...
	--- selectRenderTarget - client - libs_cl/render.lua#L1156
	---@param name string? Name of the render target to use
	function _G.render.selectRenderTarget(name) end
	--- pushMatrix - client - libs_cl/render.lua#L718
	...
	--- setMaterialEffectDownsample - client - libs_cl/render.lua#L1032
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- destroyRenderTarget - client - libs_cl/render.lua#L1143
	---@param name string Rendertarget name
	function _G.render.destroyRenderTarget(name) end
	--- drawPixelsSubrectRGBA - client - libs_cl/render.lua#L1588
	...
	--- pushViewMatrix - client - libs_cl/render.lua#L782
	...
	--- drawPixelsSubrectRGB - client - libs_cl/render.lua#L1565
	---@param dstX number Destination x coordinate
	---@param dstY number Destination y coordinate
	---@param srcX number Source x coordinate
	---@param srcY number Source y coordinate
	...
	--- drawTexturedRectRotated - client - libs_cl/render.lua#L1505
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getTextSize - client - libs_cl/render.lua#L1688
	...
	--- drawFilledCircle - client - libs_cl/render.lua#L1369
	---@param x number Center x coordinate
	---@param y number Center y coordinate
	---@param r number Radius
	function _G.render.drawFilledCircle(x, y, r) end
	--- disableScissorRect - client - libs_cl/render.lua#L753
	function _G.render.disableScissorRect() end
	--- setMaterialEffectAdd - client - libs_cl/render.lua#L978
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	function _G.render.setMaterialEffectAdd(mat) end
	--- draw3DSphere - client - libs_cl/render.lua#L1866
	---@param pos Vector Position of the sphere
	---@param radius number Radius of the sphere
	---@param longitudeSteps number The amount of longitude steps. The larger this number is, the smoother the sphere is
	---@param latitudeSteps number The amount of latitude steps. The larger this number is, the smoother the sphere is
	function _G.render.draw3DSphere(pos, radius, longitudeSteps, latitudeSteps) end
	--- setStencilPassOperation - client - libs_cl/render.lua#L662
	---@param operation number 
	function _G.render.setStencilPassOperation(operation) end
	--- clearDepth - client - libs_cl/render.lua#L1848
	function _G.render.clearDepth() end
	--- setStencilFailOperation - client - libs_cl/render.lua#L654
	---@param operation number 
	function _G.render.setStencilFailOperation(operation) end
	--- popMatrix - client - libs_cl/render.lua#L759
	function _G.render.popMatrix() end
	--- setMaterialEffectBloom - client - libs_cl/render.lua#L1006
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- enableDepth - client - libs_cl/render.lua#L1808
	...
	--- drawTexturedRectUVFast - client - libs_cl/render.lua#L1421
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	...
	--- clearStencil - client - libs_cl/render.lua#L582
	function _G.render.clearStencil() end
	--- drawBlurEffect - client - libs_cl/render.lua#L1098
...
---@class Markup
_G.Markup = {}
	--- getSize - client - libs_cl/render.lua#L1795
	...
	--- draw - client - libs_cl/render.lua#L1771
	...
	--- getWidth - client - libs_cl/render.lua#L1783
	---@return number undefined The width of the object
	function _G.Markup:getWidth() end
	--- getHeight - client - libs_cl/render.lua#L1789
	---@return number undefined The height of the object
