...
_G.file = {}
	--- exists - client - libs_cl/file.lua#L362
	...
	--- find - client - libs_cl/file.lua#L451
	...
	--- write - client - libs_cl/file.lua#L283
	---@param path string Filepath relative to data/sf_filedata/.
	---@param data string The data to write
	function _G.file.write(path, data) end
	--- readInGame - client - libs_cl/file.lua#L235
	...
	--- read - client - libs_cl/file.lua#L226
	---@param path string Filepath relative to data/sf_filedata/.
	---@return string? undefined Contents, or nil if error
	function _G.file.read(path) end
	--- writeTemp - client - libs_cl/file.lua#L312
	...
	--- existsTemp - client - libs_cl/file.lua#L332
	...
	--- open - client - libs_cl/file.lua#L196
	---@param path string Filepath relative to data/sf_filedata/.
	...
	--- delete - client - libs_cl/file.lua#L389
	---@param path string Filepath relative to data/sf_filedata/.
	...
	function _G.file.delete(path, recursive) end
	--- createDir - client - libs_cl/file.lua#L443
	---@param path string Filepath relative to data/sf_filedata/.
	function _G.file.createDir(path) end
	--- deleteTemp - client - libs_cl/file.lua#L408
	---@param filename string The temp file name. Must be only a file and not a path
	---@return boolean? undefined True if successful, nil if it wasn't found
	function _G.file.deleteTemp(filename) end
	--- asyncReadInGame - client - libs_cl/file.lua#L259
	---@param path string File path relative to GarrysMod/garrysmod/.
	---@param callback function A callback function that runs when the read operation completes. With arguments:
 ...
 3. string data - The data read from the file
	function _G.file.asyncReadInGame(path, callback) end
	--- size - client - libs_cl/file.lua#L485
	---@param path string Filepath relative to data/sf_filedata/.
	---@return number undefined Size in bytes
	function _G.file.size(path) end
	--- append - client - libs_cl/file.lua#L348
	---@param path string Filepath relative to data/sf_filedata/.
	---@param data string String that will be appended to the file.
	function _G.file.append(path, data) end
	--- findInGame - client - libs_cl/file.lua#L463
	---@param path string The folder to enumerate, relative to garrysmod.
	---@param sorting string? Optional sorting argument. Either nameasc, namedesc, dateasc, datedesc
	---@return table undefined Table of file names
	---@return table undefined Table of directory names
	function _G.file.findInGame(path, sorting) end
	--- openInGame - client - libs_cl/file.lua#L211
	---@param path string File path relative to GarrysMod/garrysmod/.
	---@param mode string The file mode to use. See Lua manual for explanation
	---@return File? undefined File object, or no value if it failed
	function _G.file.openInGame(path, mode) end
	--- asyncRead - client - libs_cl/file.lua#L244
	---@param path string Filepath relative to data/sf_filedata/.
...
_G.constraint = {}
	...
	--- setElasticLength - server - libs_sv/constraint.lua#L494
	...
	--- slider - server - libs_sv/constraint.lua#L399
	---@param e1 Entity The first entity
	---@param e2 Entity The second entity
	---@param bone1 number? Number bone of the first entity. Default 0
	---@param bone2 number? Number bone of the second entity. Default 0
	...
	--- setConstraintClean - server - libs_sv/constraint.lua#L598
	...
	--- breakType - server - libs_sv/constraint.lua#L570
	...
	--- keepupright - server - libs_sv/constraint.lua#L466
	...
	--- nocollide - server - libs_sv/constraint.lua#L436
	---@param e1 Entity The first entity
	---@param e2 Entity The second entity
	---@param bone1 number? Number bone of the first entity. Default 0
	---@param bone2 number? Number bone of the second entity. Default 0
	...
	--- getTable - server - libs_sv/constraint.lua#L585
	...
	--- removeAll - server - libs_sv/constraint.lua#L81
	function _G.constraint.removeAll() end
	--- constraintsLeft - server - libs_sv/constraint.lua#L604
	---@return number undefined Number of constraints able to be spawned
	function _G.constraint.constraintsLeft() end
	--- setElasticDamping - server - libs_sv/constraint.lua#L516
	---@param index number Index of the elastic constraint
	...
	--- breakAll - server - libs_sv/constraint.lua#L560
	...
	--- setElasticConstant - server - libs_sv/constraint.lua#L538
	---@param index number Index of the elastic constraint
	---@param e Entity Entity that has the elastic
...
_G.trace = {}
	--- isBoxIntersectingSphere - shared - libs_sh/trace.lua#L137
	...
	function _G.trace.hull(start, endpos, minbox, maxbox, filter, mask, colgroup, ignworld, whitelist) end
	--- decal - shared - libs_sh/trace.lua#L166
...
_G.prop.SENT_Data_Structures = {
	...
	---@param frozen boolean? True to spawn the entity in a frozen state. Default is false.
	---@return Entity undefined The prop object
	function _G.prop.createCustom(pos, ang, meshConvexes, frozen) end
	--- createRagdoll - server - libs_sv/prop.lua#L111
	---@param model string Model path
	---@param frozen boolean? True to spawn the entity in a frozen state. Default is false.
	---@return Entity undefined The ragdoll entity
	function _G.prop.createRagdoll(model, frozen) end
	--- manipulateBonesLeft - server - libs_sh/entities.lua#L435
	...
	--- createComponent - server - libs_sv/prop.lua#L235
	...
	--- canManipulateBones - server - libs_sh/entities.lua#L428
	---@return boolean undefined Returns true if you can manipulate bones, false if not
	function _G.prop.canManipulateBones() end
	--- manipulateBonesRate - server - libs_sh/entities.lua#L442
	---@return number undefined Number of bone manipulations per second the user can perform
	...
	--- canSpawn - server - libs_sv/prop.lua#L663
	---@return boolean undefined Returns true if you can spawn props, false if not
	function _G.prop.canSpawn() end
	--- getSpawnableSents - server - libs_sv/prop.lua#L307
	...
	--- getPropUndo - server - libs_sv/prop.lua#L693
...
_G.nextbot = {}
	--- ragdollsLeft - server - libs_sv/nextbot.lua#L158
	---@return number undefined Amount of nextbot ragdolls that can be spawned
	function _G.nextbot.ragdollsLeft() end
	--- nextbotsLeft - server - libs_sv/nextbot.lua#L142
	---@return number undefined Number of nextbots able to be spawned
	function _G.nextbot.nextbotsLeft() end
	--- canSpawnRagdoll - server - libs_sv/nextbot.lua#L150
	---@return boolean undefined Returns true if you can spawn nextbot ragdolls, false if not
	function _G.nextbot.canSpawnRagdoll() end
	--- canSpawn - server - libs_sv/nextbot.lua#L134
	---@return boolean undefined Returns true if you can spawn nextbots, false if not
	function _G.nextbot.canSpawn() end
	--- create - server - libs_sv/nextbot.lua#L88
	...
	function _G.nextbot.create(pos, mdl) end
	--- remove - server - libs_sv/nextbot.lua#L127
...
---@type any
_G["CLIENT"] = nil
	--- localToWorld - shared - libs_sh/builtins.lua#L1224
	...
	--- version - shared - libs_sh/builtins.lua#L296
	---@return string undefined Starfall version
	function _G.version() end
	--- sortedPairs - shared - libs_sh/builtins.lua#L138
	---@param tbl table Table to iterate over
	---@param predicate function? A function that passes two entries to be sorted
 ...
 e.g. The default predicate = function(a, b) return a[1]<b[1] end
	...
	function _G.sortedPairs(tbl, predicate) end
	--- tostring - shared - libs_sh/builtins.lua#L105
	---@param obj any Object to turn into a string
	---@return string undefined Object as a string
	function _G.tostring(obj) end
	--- isfunction - shared - libs_sh/builtins.lua#L219
	---@param x any Input to check
	---@return boolean undefined If the object is a function or not
	function _G.isfunction(x) end
	--- tonumber - shared - libs_sh/builtins.lua#L112
	---@param value any Either a string or a number to convert into a number.
	---@param base number? The numerical base of the digits in the string. Must be between 2 and 36. Default is 10.
	---@return number? undefined The number representation of the input value or nil if it couldn't be converted.
	function _G.tonumber(value, base) end
	--- throw - shared - libs_sh/builtins.lua#L1168
	...
	--- rawget - shared - libs_sh/builtins.lua#L485
	...
	--- ramUsed - shared - libs_sh/builtins.lua#L278
	...
	--- printMessage - client - libs_sh/builtins.lua#L728
	...
	--- setSoftQuota - shared - libs_sh/builtins.lua#L333
	...
	--- rawset - shared - libs_sh/builtins.lua#L476
	...
	--- hasPermission - shared - libs_sh/builtins.lua#L340
	...
	--- printRate - server - libs_sh/builtins.lua#L643
	---@return number undefined Number of bytes per second the print burst limit refills
	function _G.printRate() end
	--- setName - client - libs_sh/builtins.lua#L697
	---@param name string Name to set the chip's name to
	function _G.setName(name) end
	--- type - shared - libs_sh/builtins.lua#L156
	---@param obj any Object to get type of
	---@return string undefined The name of the object's type.
	function _G.type(obj) end
	--- eyePos - client - libs_sh/builtins.lua#L790
	---@return Vector undefined The local player's camera position
	function _G.eyePos() end
	--- printSizeLeft - server - libs_sh/builtins.lua#L635
	---@return number undefined Size of the remaining print burst in bytes
	function _G.printSizeLeft() end
	--- superuser - shared - libs_sh/builtins.lua#L63
	---@return boolean undefined Whether the chip owner is superuser
	function _G.superuser() end
	--- isnumber - shared - libs_sh/builtins.lua#L191
	---@param x any Input to check
	...
	--- permissionRequestSatisfied - client - libs_sh/builtins.lua#L391
	...
	--- shareScripts - shared - libs_sh/builtins.lua#L840
	---@param enable boolean If true, allow sharing scripts
	function _G.shareScripts(enable) end
	--- ramAverage - shared - libs_sh/builtins.lua#L284
	---@return number undefined The ram used in kilobytes
	function _G.ramAverage() end
	--- xpcall - shared - libs_sh/builtins.lua#L1119
	...
	--- enableHud - shared - libs_sh/builtins.lua#L1243
	...
	--- worldToLocal - shared - libs_sh/builtins.lua#L1205
	...
	--- assert - shared - libs_sh/builtins.lua#L1185
	...
	--- error - shared - libs_sh/builtins.lua#L1176
	---@param msg string Message string
	...
	--- getmetatable - shared - libs_sh/builtins.lua#L226
	...
	--- loadstring - shared - libs_sh/builtins.lua#L958
	...
	--- requiredir - shared - libs_sh/builtins.lua#L861
	---@param path string The directory to include. Make sure to --@includedir it
	---@param loadpriority table? Table of files that should be loaded before any others in the directory
	---@return table undefined Table of return values of the scripts
	...
	--- concmd - shared - libs_sh/builtins.lua#L650
	---@param cmd string Command to execute
	function _G.concmd(cmd) end
	--- require - shared - libs_sh/builtins.lua#L847
	...
	function _G.require(path, args) end
	--- printConsole - shared - libs_sh/builtins.lua#L598
	---@param printArgs ... Values to print. Colors before text will set the text color
	function _G.printConsole(printArgs) end
	--- getScript - shared - libs_sh/builtins.lua#L805
	...
	--- printHud - shared - libs_sh/builtins.lua#L607
	...
	--- printTable - shared - libs_sh/builtins.lua#L627
	...
	--- cpuTotalUsed - shared - libs_sh/builtins.lua#L306
	---@return number undefined Total used CPU time of all your chips.
	function _G.cpuTotalUsed() end
	--- setmetatable - shared - libs_sh/builtins.lua#L183
	...
	--- select - shared - libs_sh/builtins.lua#L97
	---@param parameter any 
	...
	--- concmdRate - server - libs_sh/builtins.lua#L671
	---@return number undefined Number of concmds per second the user can run on server-side
	function _G.concmdRate() end
	--- getUserdata - server - libs_sh/builtins.lua#L690
	---@return string undefined String data
	function _G.getUserdata() end
	--- concmdLeft - server - libs_sh/builtins.lua#L663
	---@return number undefined Number of concmds able to be ran serverside
	function _G.concmdLeft() end
	--- eyeAngles - client - libs_sh/builtins.lua#L783
...
_G.table = {}
	...
	--- merge - shared - libs_sh/table.lua#L243
	...
	---@return string undefined The table formatted as a string
	...
	--- copy - shared - libs_sh/table.lua#L215
	...
	function _G.table.copy(tbl, lookup_table) end
	...
	function _G.table.shuffle(tbl) end
...
---  Input library.
_G.input = {}
	--- getAnalogValue - client - libs_sh/input.lua#L414
	...
	--- lookupKeyBinding - client - libs_sh/input.lua#L241
	...
	--- getCursorPos - client - libs_sh/input.lua#L306
...
---  Effects library.
_G.effect = {}
	--- beamRingPoint - shared - libs_sh/effect.lua#L66
...
_G.render.Vertex = {
	...
	--- setFogEnd - client - libs_cl/render.lua#L2732
	---@param distance number End distance
	function _G.render.setFogEnd(distance) end
	--- setRGBA - client - libs_cl/render.lua#L976
	---@param r number Number, red value
	---@param g number Number, green value
	---@param b number Number, blue value
	---@param a number Number, alpha value
	function _G.render.setRGBA(r, g, b, a) end
	--- getTintRGBA - client - libs_cl/render.lua#L1000
	...
	--- clearBuffersObeyStencil - client - libs_cl/render.lua#L697
	...
	--- popViewMatrix - client - libs_cl/render.lua#L895
	function _G.render.popViewMatrix() end
	--- overrideBlend - client - libs_cl/render.lua#L2035
	...
	--- setFogHeight - client - libs_cl/render.lua#L2741
	---@param height number The fog height
	function _G.render.setFogHeight(height) end
	--- drawPixelsRGB - client - libs_cl/render.lua#L1736
	...
	--- drawTexturedRectRotatedFast - client - libs_cl/render.lua#L1679
	...
	--- drawPixelsRGBA - client - libs_cl/render.lua#L1752
	---@param w number Width of image to be drawn.
	---@param h number Height of image to be drawn.
	---@param dataR table Red channel data.
	---@param dataG table Green channel data.
	...
	--- popCustomClipPlane - client - libs_cl/render.lua#L2652
	function _G.render.popCustomClipPlane() end
	--- drawRoundedBox - client - libs_cl/render.lua#L1408
	...
	--- enableClipping - client - libs_cl/render.lua#L2621
	...
	--- draw3DBox - client - libs_cl/render.lua#L2123
	...
	--- draw3DQuadEasy - client - libs_cl/render.lua#L2190
	...
	--- add3DBeam - client - libs_cl/render.lua#L2163
	...
	--- drawRectOutline - client - libs_cl/render.lua#L1498
	...
	--- start3DBeam - client - libs_cl/render.lua#L2156
	...
	--- drawTexturedTriangleUV - client - libs_cl/render.lua#L1722
	...
	--- getResolution - client - libs_cl/render.lua#L2425
	...
	--- traceSurfaceColor - client - libs_cl/render.lua#L2448
	...
	--- setStencilPassOperation - client - libs_cl/render.lua#L737
	---@param operation number 
	function _G.render.setStencilPassOperation(operation) end
	--- drawTexturedRectRotated - client - libs_cl/render.lua#L1692
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getViewSetup - client - libs_cl/render.lua#L2360
	...
	--- getMatrix - client - libs_cl/render.lua#L834
	---@return VMatrix undefined The currently active matrix.
	function _G.render.getMatrix() end
	--- setModelLighting - client - libs_cl/render.lua#L678
	...
	--- draw3DWireframeBox - client - libs_cl/render.lua#L2133
	---@param origin Vector Origin of the box.
	---@param angle Angle Orientation of the box
	---@param mins Vector Start position of the box, relative to origin.
	---@param maxs Vector End position of the box, relative to origin.
	...
	--- draw3DWireframeSphere - client - libs_cl/render.lua#L2099
	...
	--- pushCustomClipPlane - client - libs_cl/render.lua#L2636
	...
	--- setMaterialEffectSub - client - libs_cl/render.lua#L1090
	...
	--- readPixel - client - libs_cl/render.lua#L2404
	...
	--- pushMatrix - client - libs_cl/render.lua#L793
	...
	--- depthRange - client - libs_cl/render.lua#L2827
	...
	--- destroyRenderTarget - client - libs_cl/render.lua#L1241
	---@param name string Rendertarget name
	function _G.render.destroyRenderTarget(name) end
	--- pushViewMatrix - client - libs_cl/render.lua#L849
	...
	--- getTextSize - client - libs_cl/render.lua#L1891
	...
	--- disableScissorRect - client - libs_cl/render.lua#L820
	function _G.render.disableScissorRect() end
	--- setMaterialEffectAdd - client - libs_cl/render.lua#L1076
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	function _G.render.setMaterialEffectAdd(mat) end
	--- draw3DSphere - client - libs_cl/render.lua#L2087
	---@param pos Vector Position of the sphere
	---@param radius number Radius of the sphere
	---@param longitudeSteps number The amount of longitude steps. The larger this number is, the smoother the sphere is
	---@param latitudeSteps number The amount of latitude steps. The larger this number is, the smoother the sphere is
	function _G.render.draw3DSphere(pos, radius, longitudeSteps, latitudeSteps) end
	--- setMaterialEffectBloom - client - libs_cl/render.lua#L1104
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- setFogMode - client - libs_cl/render.lua#L2696
	---@param mode number Fog mode
	function _G.render.setFogMode(mode) end
	--- clearStencil - client - libs_cl/render.lua#L657
	function _G.render.clearStencil() end
	--- draw3DQuadUV - client - libs_cl/render.lua#L2223
	...
	--- createFont - client - libs_cl/render.lua#L1826
 ...
 \- Times New Roman
	...
	--- isInRenderTarget - client - libs_cl/render.lua#L1254
	...
	--- getAngles - client - libs_cl/render.lua#L635
	...
	--- setFont - client - libs_cl/render.lua#L1900
 ...
 \- DermaLarge
	...
	--- drawRectRotatedFast - client - libs_cl/render.lua#L1471
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getEyePos - client - libs_cl/render.lua#L627
	...
	--- readPixelRGBA - client - libs_cl/render.lua#L2413
	---@param x number Pixel x-coordinate.
	---@param y number Pixel y-coordinate.
	...
	--- drawTriangle - client - libs_cl/render.lua#L1572
	...
	--- parseMarkup - client - libs_cl/render.lua#L1984
	...
	--- computeLighting - client - libs_cl/render.lua#L2662
	...
	--- drawRect - client - libs_cl/render.lua#L1459
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawRect(x, y, w, h) end
	--- resetModelLighting - client - libs_cl/render.lua#L688
	...
	--- end3DBeam - client - libs_cl/render.lua#L2173
	function _G.render.end3DBeam() end
	--- renderTargetExists - client - libs_cl/render.lua#L1218
	...
	--- drawBlurEffect - client - libs_cl/render.lua#L1196
	...
	--- setStencilZFailOperation - client - libs_cl/render.lua#L745
	---@param operation number 
	function _G.render.setStencilZFailOperation(operation) end
	--- capturePixels - client - libs_cl/render.lua#L2373
	function _G.render.capturePixels() end
	--- drawSimpleTextOutlined - client - libs_cl/render.lua#L1966
	---@param x number X coordinate
	---@param y number Y coordinate
	---@param text string Text to draw
	...
	--- destroyTexture - client - libs_cl/render.lua#L1040
	---@param mat Material The material object
	function _G.render.destroyTexture(mat) end
	--- draw3DBeam - client - libs_cl/render.lua#L2145
	---@param startPos Vector Beam start position.
	...
	--- setStencilEnable - client - libs_cl/render.lua#L649
	---@param enable boolean True to enable, false to disable
	function _G.render.setStencilEnable(enable) end
	--- createRenderTarget - client - libs_cl/render.lua#L1226
	---@param name string The name of the render target
	function _G.render.createRenderTarget(name) end
	--- setTint - client - libs_cl/render.lua#L1012
	---@param c Color A color
	function _G.render.setTint(c) end
	--- drawPoly - client - libs_cl/render.lua#L2023
	...
	--- captureImage - client - libs_cl/render.lua#L2380
	...
	--- cursorPos - client - libs_cl/render.lua#L2302
	...
	--- clearStencilBufferRectangle - client - libs_cl/render.lua#L709
	...
	--- setMaterialEffectColorModify - client - libs_cl/render.lua#L1163
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- selectRenderTarget - client - libs_cl/render.lua#L1260
	---@param name string? Name of the render target to use
	function _G.render.selectRenderTarget(name) end
	--- setColorModulation - client - libs_cl/render.lua#L964
	---@param r number Red channel
	---@param g number Green channel
	---@param b number Blue channel
	function _G.render.setColorModulation(r, g, b) end
	--- createMaterial - client - libs_cl/render.lua#L1019
	...
	--- drawTexturedRectUV - client - libs_cl/render.lua#L1650
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	...
	--- drawRectRotated - client - libs_cl/render.lua#L1484
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- getEyeVector - client - libs_cl/render.lua#L641
	...
	--- popMatrix - client - libs_cl/render.lua#L826
	function _G.render.popMatrix() end
	--- computeDynamicLighting - client - libs_cl/render.lua#L2672
	---@param pos Vector Vector position to sample from
	---@param normal Vector Normal vector of the surface
	---@return Vector undefined Vector representing color of the light
	function _G.render.computeDynamicLighting(pos, normal) end
	--- getColorModulation - client - libs_cl/render.lua#L955
	...
	--- draw3DQuad - client - libs_cl/render.lua#L2179
	...
	--- enableDepth - client - libs_cl/render.lua#L2028
	---@param enable boolean True to enable
	function _G.render.enableDepth(enable) end
	--- draw3DTriangle - client - libs_cl/render.lua#L2254
	...
	--- drawTexturedRectUVFast - client - libs_cl/render.lua#L1612
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	...
	--- setStencilWriteMask - client - libs_cl/render.lua#L769
	---@param mask number The mask bitflag.
...
_G.wire.ports = {
}	--- isConnected - server - libs_sv/wire.lua#L614
	---@param ent Entity Entity with input
	---@param inputName string Input name to check
	---@return boolean undefined Whether the input is connected
	function _G.wire.isConnected(ent, inputName) end
	--- self - server - libs_sv/wire.lua#L492
	---@return Wirelink undefined Wirelink representing this entity
	function _G.wire.self() end
	--- triggerCell - server - libs_sv/wire.lua#L751
	...
	--- adjustInputs - server - libs_sv/wire.lua#L339
	...
	--- create - server - libs_sv/wire.lua#L507
	---@param entI Entity Entity with input
	---@param entO Entity Entity with output
	---@param inputname string Input to be wired
	---@param outputname string Output to be wired. May be "entity" or "wirelink" to specify an entity/wirelink output
	...
	--- adjustOutputs - server - libs_sv/wire.lua#L383
	...
	--- getInputs - server - libs_sv/wire.lua#L598
	...
	--- getOutputTargets - server - libs_sv/wire.lua#L645
	---@param ent Entity Entity with the output
	---@param outputName string Name of the output to check
	---@return table undefined A table of destination connections. Each entry is a table with fields `Entity` (the destination entity) and `Name` (the input name on that entity). Returns an empty table if not wired.
	function _G.wire.getOutputTargets(ent, outputName) end
	--- getInputSource - server - libs_sv/wire.lua#L628
	---@param ent Entity Entity with input
	---@param inputName string Input name to check
	---@return Entity? undefined Source entity, or nil if not wired
	---@return string? undefined Output name on the source entity, or nil if not wired
	function _G.wire.getInputSource(ent, inputName) end
	--- readOutput - server - libs_sv/wire.lua#L774
	...
	--- triggerOutput - server - libs_sv/wire.lua#L740
	---@param ent Entity Entity with output
	---@param outputname string Output name
	...
	--- triggerInput - server - libs_sv/wire.lua#L729
	---@param ent Entity Entity with input
	---@param inputname string Input name
...
---@class NextBot
_G.NextBot = {}
	--- removeApproachPos - server - libs_sv/nextbot.lua#L181
	function _G.NextBot:removeApproachPos() end
	--- setRunAct - server - libs_sv/nextbot.lua#L255
	---@param act number The activity the nextbot will use.
	function _G.NextBot:setRunAct(act) end
	--- setVelocity - server - libs_sv/nextbot.lua#L295
	---@param vel Vector Velocity.
	function _G.NextBot:setVelocity(vel) end
	--- setJumpGapsAllowed - server - libs_sv/nextbot.lua#L720
	---@param val boolean Whether this bot should be allowed to jump gaps.
	function _G.NextBot:setJumpGapsAllowed(val) end
	--- getRunAct - server - libs_sv/nextbot.lua#L267
	---@return number undefined The run activity.
	function _G.NextBot:getRunAct() end
	--- setStepHeight - server - libs_sv/nextbot.lua#L639
	---@param val number Height (default is 18)
	function _G.NextBot:setStepHeight(val) end
	--- removeGotoPos - server - libs_sv/nextbot.lua#L211
	function _G.NextBot:removeGotoPos() end
	--- getMaxYawRate - server - libs_sv/nextbot.lua#L585
	---@return number undefined The nextbot's current maximum yaw rate.
	function _G.NextBot:getMaxYawRate() end
	--- getDeathDropHeight - server - libs_sv/nextbot.lua#L631
	---@return number undefined Height nextbot is afraid of.
	function _G.NextBot:getDeathDropHeight() end
	--- playSequence - server - libs_sv/nextbot.lua#L227
	---@param seq string The name of the sequence to play.
	function _G.NextBot:playSequence(seq) end
	--- jumpAcrossGap - server - libs_sv/nextbot.lua#L756
	...
	--- removeDeathCallback - server - libs_sv/nextbot.lua#L356
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeDeathCallback(id) end
	--- setGravity - server - libs_sv/nextbot.lua#L611
	---@param val number NB's new gravity. Default is 1000
	function _G.NextBot:setGravity(val) end
	--- addLeaveGroundCallback - server - libs_sv/nextbot.lua#L410
	...
	function _G.NextBot:addLeaveGroundCallback(id, func) end
	--- addInjuredCallback - server - libs_sv/nextbot.lua#L366
	---@param id string The unique ID this callback will use.
	...
	function _G.NextBot:addInjuredCallback(id, func) end
	--- setMaxYawRate - server - libs_sv/nextbot.lua#L593
	---@param val number Desired new maximum yaw rate
	function _G.NextBot:setMaxYawRate(val) end
	--- removeNavChangeCallback - server - libs_sv/nextbot.lua#L466
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeNavChangeCallback(id) end
	--- getGroundMotionVector - server - libs_sv/nextbot.lua#L657
	---@return Vector undefined A vector representing the X and Y movement.
	function _G.NextBot:getGroundMotionVector() end
	--- addDeathCallback - server - libs_sv/nextbot.lua#L344
	---@param id string The unique ID this callback will use.
	...
	--- setJumpHeight - server - libs_sv/nextbot.lua#L738
	---@param val number Height (default is 58)
	function _G.NextBot:setJumpHeight(val) end
	--- setGotoPos - server - libs_sv/nextbot.lua#L197
	---@param pos Vector The position the nextbot will continuosly try to go to.
	function _G.NextBot:setGotoPos(pos) end
	--- addNavChangeCallback - server - libs_sv/nextbot.lua#L454
	---@param id string The unique ID this callback will use.
	---@param func function The function to run when the NB enters a new nav area. The arguments are: (Old Nav Area, New Nav Area)
	function _G.NextBot:addNavChangeCallback(id, func) end
	--- setDeathDropHeight - server - libs_sv/nextbot.lua#L621
	---@param val number New height nextbot is afraid of. Default is 200.
	function _G.NextBot:setDeathDropHeight(val) end
	--- getJumpHeight - server - libs_sv/nextbot.lua#L748
	---@return number undefined Jump height
	function _G.NextBot:getJumpHeight() end
	--- getDeceleration - server - libs_sv/nextbot.lua#L577
	---@return number undefined NB's deceleration value.
	function _G.NextBot:getDeceleration() end
	--- addIgniteCallback - server - libs_sv/nextbot.lua#L432
	---@param id string The unique ID this callback will use.
	---@param func function The function to run when the NB gets ignited.
	function _G.NextBot:addIgniteCallback(id, func) end
	--- ragdollOnDeath - server - libs_sv/nextbot.lua#L520
	---@param bool boolean Whether the nextbot should ragdoll on death.
	function _G.NextBot:ragdollOnDeath(bool) end
	--- addRagdollCreationCallback - server - libs_sv/nextbot.lua#L498
	---@param id string The unique ID this callback will use.
	---@param func function The function to run when the NB create a ragdoll. The arguments are: (The ragdoll entity the NB created.)
	function _G.NextBot:addRagdollCreationCallback(id, func) end
	--- removeInjuredCallback - server - libs_sv/nextbot.lua#L378
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeInjuredCallback(id) end
	--- setDeceleration - server - libs_sv/nextbot.lua#L567
	---@param val number NB's new deceleration. Default is 400
	function _G.NextBot:setDeceleration(val) end
	--- setMoveSpeed - server - libs_sv/nextbot.lua#L530
	---@param val number NB's new move speed. Default is 200.
	function _G.NextBot:setMoveSpeed(val) end
	--- getMoveSpeed - server - libs_sv/nextbot.lua#L541
	---@return number undefined NB's move speed.
	function _G.NextBot:getMoveSpeed() end
	--- removeRagdollCreationCallback - server - libs_sv/nextbot.lua#L510
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeRagdollCreationCallback(id) end
	--- getAcceleration - server - libs_sv/nextbot.lua#L559
	---@return number undefined NB's acceleration value.
	function _G.NextBot:getAcceleration() end
	--- faceTowards - server - libs_sv/nextbot.lua#L246
	---@param pos Vector Position to face towards.
	function _G.NextBot:faceTowards(pos) end
	--- removeIgniteCallback - server - libs_sv/nextbot.lua#L444
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeIgniteCallback(id) end
	--- jump - server - libs_sv/nextbot.lua#L312
	---@param act number? The activity ID of the anim to play when jumping.
	function _G.NextBot:jump(act) end
	--- setAcceleration - server - libs_sv/nextbot.lua#L549
	---@param val number NB's new acceleration. Default is 400
	function _G.NextBot:setAcceleration(val) end
	--- setApproachPos - server - libs_sv/nextbot.lua#L166
	---@param pos Vector The vector we want to get to.
	function _G.NextBot:setApproachPos(pos) end
	--- getApproachPos - server - libs_sv/nextbot.lua#L189
	...
	--- addContactCallback - server - libs_sv/nextbot.lua#L476
	---@param id string The unique ID this callback will use.
	---@param func function The function to run when the NB touches another entity. The arguments are: (The entity the NB touched.)
	function _G.NextBot:addContactCallback(id, func) end
	--- removeContactCallback - server - libs_sv/nextbot.lua#L488
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeContactCallback(id) end
	--- removeReachCallback - server - libs_sv/nextbot.lua#L334
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeReachCallback(id) end
	--- startActivity - server - libs_sv/nextbot.lua#L237
	---@param act number The ACT enum to play.
	function _G.NextBot:startActivity(act) end
	--- removeLandCallback - server - libs_sv/nextbot.lua#L400
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeLandCallback(id) end
	--- addReachCallback - server - libs_sv/nextbot.lua#L322
	---@param id string The unique ID this callback will use.
	---@param func function The function to run when the NB reaches its destination.
	function _G.NextBot:addReachCallback(id, func) end
	--- getStepHeight - server - libs_sv/nextbot.lua#L649
	---@return number undefined The max height the bot can step up.
	function _G.NextBot:getStepHeight() end
	--- removeLeaveGroundCallback - server - libs_sv/nextbot.lua#L422
	---@param id string The unique ID of the callback to remove.
	function _G.NextBot:removeLeaveGroundCallback(id) end
	--- getGotoPos - server - libs_sv/nextbot.lua#L219
	---@return Vector? undefined Where the nextbot is trying to go to if it exists, else returns nil.
	function _G.NextBot:getGotoPos() end
	--- getIdleAct - server - libs_sv/nextbot.lua#L287
	---@return number undefined The idle activity.
	function _G.NextBot:getIdleAct() end
	--- setIdleAct - server - libs_sv/nextbot.lua#L275
	---@param act number The activity the nextbot will use.
	function _G.NextBot:setIdleAct(act) end
---  The Markup type is used to easily format and draw text. Use render.parseMarkup(str, maxwidth) to create one.
---@class Markup
_G.Markup = {}
	--- getSize - client - libs_cl/render.lua#L2016
	...
	--- draw - client - libs_cl/render.lua#L1992
	...
	--- getWidth - client - libs_cl/render.lua#L2004
	---@return number undefined The width of the object
	function _G.Markup:getWidth() end
	--- getHeight - client - libs_cl/render.lua#L2010
	---@return number undefined The height of the object
	function _G.Markup:getHeight() end
---  Hologram type
---@class Hologram
_G.Hologram = {}
	--- setCullMode - shared - libs_sh/hologram.lua#L505
	---@param mode number Cull mode. 0 for counter clock wise, 1 for clock wise
	...
	--- setAnimation - shared - libs_sh/hologram.lua#L474
	...
	--- suppressEngineLighting - shared - libs_sh/hologram.lua#L442
	...
	--- setScale - shared - libs_sh/hologram.lua#L412
	---@param scale Vector Vector new scale
	function _G.Hologram:setScale(scale) end
	--- setRenderGroup - shared - libs_sh/hologram.lua#L517
	...
	--- getScale - shared - libs_sh/hologram.lua#L434
	---@return Vector undefined Vector scale
	function _G.Hologram:getScale() end
	--- setSize - shared - libs_sh/hologram.lua#L421
	...
	--- addEffects - shared - libs_sh/hologram.lua#L533
	...
	--- setModel - shared - libs_sh/hologram.lua#L460
	---@param model string string model path
	function _G.Hologram:setModel(model) end
	--- getPlayerColor - shared - libs_sh/hologram.lua#L363
	...
	--- setPlayerColor - shared - libs_sh/hologram.lua#L351
...
---@class CMoveData
_G.CMoveData = {}
	--- getButtons - shared - libs_sh/usercmd.lua#L117
	---@return number undefined The button bitflag
	function _G.CMoveData:getButtons() end
	--- getOldButtons - shared - libs_sh/usercmd.lua#L147
	---@return number undefined The button bitflag
	function _G.CMoveData:getOldButtons() end
	--- getSideSpeed - shared - libs_sh/usercmd.lua#L159
	---@return number undefined The strafe speed
	function _G.CMoveData:getSideSpeed() end
	--- getForwardSpeed - shared - libs_sh/usercmd.lua#L123
	---@return number undefined The forward speed
	function _G.CMoveData:getForwardSpeed() end
	--- getOrigin - shared - libs_sh/usercmd.lua#L153
	---@return Vector undefined The player's position
	function _G.CMoveData:getOrigin() end
	--- keyReleased - shared - libs_sh/usercmd.lua#L191
	---@param buttons number The button(s) to check, see https://wiki.facepunch.com/gmod/Enums/IN for the button enums
	---@return boolean undefined true if the button(s) was released, false if not
	function _G.CMoveData:keyReleased(buttons) end
	--- getMaxSpeed - shared - libs_sh/usercmd.lua#L141
	---@return number undefined The max speed
	function _G.CMoveData:getMaxSpeed() end
	--- getImpulse - shared - libs_sh/usercmd.lua#L129
	---@return number undefined The impulse
	function _G.CMoveData:getImpulse() end
	--- keyPressed - shared - libs_sh/usercmd.lua#L184
	---@param buttons number The button(s) to check, see https://wiki.facepunch.com/gmod/Enums/IN for the button enums
	---@return boolean undefined true if the button(s) was pressed, false if not
	function _G.CMoveData:keyPressed(buttons) end
	--- keyDown - shared - libs_sh/usercmd.lua#L177
	---@param buttons number The button(s) to check, see https://wiki.facepunch.com/gmod/Enums/IN for the button enums
	---@return boolean undefined true if the button(s) is down, false if not
	function _G.CMoveData:keyDown(buttons) end
	--- getEyeAngles - shared - libs_sh/usercmd.lua#L111
	---@return Angle undefined The aim angle
	function _G.CMoveData:getEyeAngles() end
	--- getVelocity - shared - libs_sh/usercmd.lua#L171
	---@return Vector undefined The player's velocity
	function _G.CMoveData:getVelocity() end
	--- getUpSpeed - shared - libs_sh/usercmd.lua#L165
	---@return number undefined The vertical speed
	function _G.CMoveData:getUpSpeed() end
	--- getMaxClientSpeed - shared - libs_sh/usercmd.lua#L135
	---@return number undefined The max speed
	function _G.CMoveData:getMaxClientSpeed() end
	--- keyDownLast - shared - libs_sh/usercmd.lua#L198
	---@param buttons number The button(s) to check, see https://wiki.facepunch.com/gmod/Enums/IN for the button enums
	---@return boolean undefined true if the button(s) is down, false if not
	function _G.CMoveData:keyDownLast(buttons) end
...
_G.Quaternion = {}
	--- getMatrix - shared - libs_sh/quaternion.lua#L669
	...
	--- getInverse - shared - libs_sh/quaternion.lua#L611
	---@return Quaternion undefined Inverse of the quaternion
	function _G.Quaternion:getInverse() end
	--- getConjugate - shared - libs_sh/quaternion.lua#L597
...
_G.ParticleEffect = {}
	--- setSortOrigin - client - libs_cl/particle_effect.lua#L158
	---@param origin Vector Sort Origin
	function _G.ParticleEffect:setSortOrigin(origin) end
	--- restart - client - libs_cl/particle_effect.lua#L135
	function _G.ParticleEffect:restart() end
	--- stopEmission - client - libs_cl/particle_effect.lua#L113
	function _G.ParticleEffect:stopEmission() end
	--- setControlPointEntity - client - libs_cl/particle_effect.lua#L183
...
_G.Wirelink = {}
	...
	--- outputType - server - libs_sv/wire.lua#L860
	...
	--- isWired - server - libs_sv/wire.lua#L918
...
_G.NavArea = {}
	...
	--- isConnectedAtSide - server - libs_sv/navmesh.lua#L302
	...
	--- addToOpenList - server - libs_sv/navmesh.lua#L769
	function _G.NavArea:addToOpenList() end
	--- hasAttributes - server - libs_sv/navmesh.lua#L574
	...
	--- getParentHow - server - libs_sv/navmesh.lua#L515
	---@return number undefined 
	function _G.NavArea:getParentHow() end
	--- getCorner - server - libs_sv/navmesh.lua#L412
	...
	--- getAttributes - server - libs_sv/navmesh.lua#L390
	...
	--- setParent - server - libs_sv/navmesh.lua#L714
	...
	--- computeDirection - server - libs_sv/navmesh.lua#L320
	...
	--- getCostSoFar - server - libs_sv/navmesh.lua#L421
	---@return number undefined The cost so far.
	function _G.NavArea:getCostSoFar() end
	--- removeFromClosedList - server - libs_sv/navmesh.lua#L687
	function _G.NavArea:removeFromClosedList() end
	--- getHidingSpots - server - libs_sv/navmesh.lua#L428
	---@param type number? Bit mask of spot types to include, defaults to 1. Multiple types can be combined.
 ...
 Values over 255 and below 0 will be clamped.
	...
	function _G.NavArea:getHidingSpots(type) end
	--- setPlace - server - libs_sv/navmesh.lua#L722
	...
	--- isRoughlySquare - server - libs_sv/navmesh.lua#L646
	---@return boolean undefined If we're a square or not.
	function _G.NavArea:isRoughlySquare() end
	--- getIncomingConnections - server - libs_sv/navmesh.lua#L479
	...
	--- isCompletelyVisible - server - libs_sv/navmesh.lua#L602
	...
	--- getID - server - libs_sv/navmesh.lua#L472
	---@return number undefined The unique ID.
	function _G.NavArea:getID() end
	--- isBlocked - server - libs_sv/navmesh.lua#L583
	...
	--- isUnderwater - server - libs_sv/navmesh.lua#L271
	---@return boolean undefined Whether we're underwater or not.
	function _G.NavArea:isUnderwater() end
	--- isOverlappingArea - server - libs_sv/navmesh.lua#L621
	...
	--- getExposedSpots - server - libs_sv/navmesh.lua#L448
	---@return table undefined A table of Vectors
	function _G.NavArea:getExposedSpots() end
	--- isPotentiallyVisible - server - libs_sv/navmesh.lua#L638
	---@param area NavArea The area to test.
	...
	--- isPartiallyVisible - server - libs_sv/navmesh.lua#L629
	...
	--- contains - server - libs_sv/navmesh.lua#L278
	...
	--- getZ - server - libs_sv/navmesh.lua#L566
	...
	function _G.NavArea:getZ(pos) end
	--- isCoplanar - server - libs_sv/navmesh.lua#L312
	...
	--- getAdjacentCount - server - libs_sv/navmesh.lua#L372
	...
	--- computeAdjacentConnectionHeightChange - server - libs_sv/navmesh.lua#L336
	---@param other NavArea The nav area to test against.
	---@return number undefined The height change
	function _G.NavArea:computeAdjacentConnectionHeightChange(other) end
	--- isOverlapping - server - libs_sv/navmesh.lua#L610
	---@param pos Vector The position to test.
	...
	--- getAdjacentCountAtSide - server - libs_sv/navmesh.lua#L380
	---@param navDir number The direction, in which to look for CNavAreas, see NAV_DIR enums.
	...
	function _G.NavArea:getAdjacentCountAtSide(navDir) end
	--- getTotalCost - server - libs_sv/navmesh.lua#L559
	---@return number undefined The total cost
	function _G.NavArea:getTotalCost() end
	--- getSizeY - server - libs_sv/navmesh.lua#L552
	---@return number undefined Height
	function _G.NavArea:getSizeY() end
	--- getPlace - server - libs_sv/navmesh.lua#L522
	...
	--- getRandomPoint - server - libs_sv/navmesh.lua#L538
...
---@operator index(number|string):number|function|Vector|nil
---@operator tostring:string
...
_G.Vector = {}
	...
	--- getQuaternion - shared - libs_sh/quaternion.lua#L782
	...
	--- getQuaternionFromRotation - shared - libs_sh/quaternion.lua#L822
	...
	--- getQuaternionFromAxis - shared - libs_sh/quaternion.lua#L810
	...
	---@return Vector undefined Basis 1
	---@return Vector undefined Basis 2
...
_G.Effect = {}
	...
	--- getOrigin - shared - libs_sh/effect.lua#L179
...
---@operator tostring:string
_G.Entity = {}
	--- localToWorld - shared - libs_sh/entities.lua#L1551
	...
	--- getHitBoxBounds - shared - libs_sh/entities.lua#L2050
	...
	--- setUnbreakable - server - libs_sv/entities.lua#L1088
	---@param on boolean Whether to make the prop unbreakable
	function _G.Entity:setUnbreakable(on) end
	--- addCollisionListener - server - libs_sv/entities.lua#L525
	...
	--- getLinkedComponents - shared - libs_sh/entities.lua#L340
	---@return table undefined A list of components linked to the entity
	function _G.Entity:getLinkedComponents() end
	--- getVelocity - shared - libs_sh/entities.lua#L1517
	---@return Vector undefined The velocity vector
	function _G.Entity:getVelocity() end
	--- setPhysMaterial - server - libs_sv/entities.lua#L790
	---@param mat string Material to use
	function _G.Entity:setPhysMaterial(mat) end
	--- getModelContents - shared - libs_sh/entities.lua#L1878
	...
	--- getBrushPlaneCount - shared - libs_sh/entities.lua#L2136
	---@return number undefined The amount of brush planes
	function _G.Entity:getBrushPlaneCount() end
	--- getCollisionGroup - shared - libs_sh/entities.lua#L867
	...
	--- setPersistent - shared - libs_sh/entities.lua#L2025
	---@param persist boolean True to make persistent
	function _G.Entity:setPersistent(persist) end
	--- mapCreationID - shared - libs_sh/entities.lua#L2276
	...
	--- getLocalPos - shared - libs_sh/entities.lua#L1248
	---@return Vector undefined The position vector
	function _G.Entity:getLocalPos() end
	--- getDTBool - shared - libs_sh/entities.lua#L2153
	...
	--- getManipulateBonePosition - shared - libs_sh/entities.lua#L1402
	...
	--- isWeldedTo - server - libs_sv/entities.lua#L974
	---@return Entity undefined The first welded/parent entity
	function _G.Entity:isWeldedTo() end
	--- getChildBones - shared - libs_sh/entities.lua#L1353
	---@param bone number Bone index (starts at 0)
	---@return table undefined Table of child bone indices
	function _G.Entity:getChildBones(bone) end
	--- getRight - shared - libs_sh/entities.lua#L1995
	---@return Vector undefined Vector right
	function _G.Entity:getRight() end
	--- lookupSequence - shared - libs_sh/entities.lua#L1611
	...
	--- getSequence - shared - libs_sh/entities.lua#L1619
	---@return number undefined The sequence number
	function _G.Entity:getSequence() end
	--- getSolidFlags - shared - libs_sh/entities.lua#L879
	...
	--- removeCollisionListener - server - libs_sv/entities.lua#L538
	...
	--- getAttachment - shared - libs_sh/entities.lua#L850
	...
	--- getAngles - shared - libs_sh/entities.lua#L1485
	---@return Angle undefined The angle
	function _G.Entity:getAngles() end
	--- getBodygroupName - shared - libs_sh/entities.lua#L722
	...
	--- getFlexes - shared - libs_sh/entities.lua#L1725
	---@return table undefined Table of flexes
	function _G.Entity:getFlexes() end
	--- translatePhysBoneToBone - shared - libs_sh/entities.lua#L904
	...
	--- getEyePos - shared - libs_sh/entities.lua#L1951
	...
	--- breakEnt - server - libs_sv/entities.lua#L675
	function _G.Entity:breakEnt() end
	--- getBrushSurfaces - shared - libs_sh/entities.lua#L2111
	...
	--- getNWVarTable - shared - libs_sh/entities.lua#L2225
	---@return table undefined The table of networked objects
	function _G.Entity:getNWVarTable() end
	--- worldToLocal - shared - libs_sh/entities.lua#L1595
	...
	--- getBoneMatrix - shared - libs_sh/entities.lua#L1271
	---@param bone number? Bone index. Default is 0.
	---@return VMatrix undefined The matrix
	function _G.Entity:getBoneMatrix(bone) end
	--- getPose - shared - libs_sh/entities.lua#L1690
	...
	--- getEffectModel - shared - libs_sh/entities.lua#L1855
	---@return string undefined Model of the effect
	function _G.Entity:getEffectModel() end
	--- removeTrails - server - libs_sv/entities.lua#L1080
	function _G.Entity:removeTrails() end
	--- setBoneMatrix - client - libs_sh/entities.lua#L1282
	---@param bone number The bone ID
	---@param matrix VMatrix The matrix to set
	function _G.Entity:setBoneMatrix(bone, matrix) end
	--- draw - client - libs_sh/entities.lua#L226
	function _G.Entity:draw() end
	--- removeInternalConstraint - server - libs_sv/entities.lua#L549
	---@param num number? The index of the constraint to remove. Negative deletes all of them. (default: -1)
	function _G.Entity:removeInternalConstraint(num) end
	--- getBrushPlane - shared - libs_sh/entities.lua#L2124
	...
	--- isNPC - shared - libs_sh/entities.lua#L1043
	---@return boolean undefined True if npc, false if not
	function _G.Entity:isNPC() end
	--- getRotatedAABB - shared - libs_sh/entities.lua#L1919
	...
	--- setInertia - server - libs_sv/entities.lua#L772
	---@param vec Vector Inertia tensor
	function _G.Entity:setInertia(vec) end
	--- getCollisionBounds - shared - libs_sh/entities.lua#L1909
	...
	--- sequenceDuration - shared - libs_sh/entities.lua#L1670
	...
	--- enableMotion - server - libs_sv/entities.lua#L876
	---@param move boolean Should the entity move?
	function _G.Entity:enableMotion(move) end
	--- getDTEntity - shared - libs_sh/entities.lua#L2163
	---@param key number The number key. Valid keys are 0 - 31
	---@return Entity? undefined The entity or nil if it doesn't exist
	function _G.Entity:getDTEntity(key) end
	--- getNetworkVars - shared - libs_sh/entities.lua#L2283
	...
	--- use - server - libs_sv/entities.lua#L712
	...
	--- manipulateBoneAngles - shared - libs_sh/entities.lua#L505
	---@param bone number The bone ID
	---@param ang Angle The angle it should be manipulated to
	function _G.Entity:manipulateBoneAngles(bone, ang) end
	--- worldToLocalVector - shared - libs_sh/entities.lua#L1568
	...
	--- getBodygroup - shared - libs_sh/entities.lua#L696
	---@param id number The bodygroup's number index
	---@return number undefined The bodygroup value
	function _G.Entity:getBodygroup(id) end
	--- getHitBoxSet - shared - libs_sh/entities.lua#L2085
	...
	--- setPhysicsUpdateListener - server - libs_sv/entities.lua#L1133
	...
	--- setDrawShadow - server - libs_sv/entities.lua#L560
	---@param draw boolean Whether the shadow should draw
	function _G.Entity:setDrawShadow(draw) end
	--- getBonePosition - shared - libs_sh/entities.lua#L1372
	---@param bone number? Bone index. (def 0)
	...
	--- setRenderMode - shared - libs_sh/entities.lua#L772
	...
	--- addVelocity - server - libs_sv/entities.lua#L652
	---@param vel Vector The world velocity vector to apply
	function _G.Entity:addVelocity(vel) end
	--- getInternalVariable - shared - libs_sh/entities.lua#L2266
	...
	--- getOwner - shared - libs_sh/entities.lua#L96
	---@return Entity? undefined Owner or nil if no owner
	function _G.Entity:getOwner() end
	--- setNocollideAll - server - libs_sv/entities.lua#L746
	...
	--- getPhysicsObjectNum - shared - libs_sh/entities.lua#L925
	...
	--- lookupBodygroup - shared - libs_sh/entities.lua#L713
	...
	--- localToWorldAngles - shared - libs_sh/entities.lua#L1587
	...
	--- getSolid - shared - libs_sh/entities.lua#L873
	...
	--- isConstraint - server - libs_sv/entities.lua#L827
	---@return boolean undefined If the entity is a constraint
	function _G.Entity:isConstraint() end
	--- setBodygroup - shared - libs_sh/entities.lua#L677
	...
	--- setPreventTransmit - server - libs_sv/entities.lua#L1234
	...
	--- getColor4Part - shared - libs_sh/entities.lua#L946
	...
	--- getColor - shared - libs_sh/entities.lua#L939
	---@return Color undefined Color
	function _G.Entity:getColor() end
	--- ignite - server - libs_sv/entities.lua#L686
	---@param length number How long the fire lasts
	---@param radius number? (optional) How large the fire hitbox is (entity obb is the max)
	function _G.Entity:ignite(length, radius) end
	--- getModel - shared - libs_sh/entities.lua#L1848
	---@return string undefined Model of the entity
	function _G.Entity:getModel() end
	--- getSaveTable - shared - libs_sh/entities.lua#L2257
	...
	--- isAlive - shared - libs_sh/entities.lua#L1064
	---@return boolean undefined True if the entity is alive, false otherwise
	function _G.Entity:isAlive() end
	--- getHitBoxSetCount - shared - libs_sh/entities.lua#L2093
	---@return number undefined Number of hitbox sets.
	function _G.Entity:getHitBoxSetCount() end
	--- getModelBounds - shared - libs_sh/entities.lua#L1868
	...
	--- getFriction - server - libs_sv/entities.lua#L411
	---@return number undefined friction
	function _G.Entity:getFriction() end
	--- setRagdollPos - server - libs_sv/entities.lua#L601
	...
	function _G.Entity:setRagdollPos(pos, ang, bone) end
	--- remove - server - libs_sv/entities.lua#L667
	function _G.Entity:remove() end
	--- isWeapon - shared - libs_sh/entities.lua#L1029
	---@return boolean undefined True if weapon, false if not
	function _G.Entity:isWeapon() end
	--- lookupAttachment - shared - libs_sh/entities.lua#L842
	...
	--- getClipping - shared - libs_sh/entities.lua#L956
	---@return table undefined Table containing the clipdata
	function _G.Entity:getClipping() end
	--- getMoveType - shared - libs_sh/entities.lua#L891
	...
	--- localToWorldVector - shared - libs_sh/entities.lua#L1560
	...
	--- getRenderGroup - client - libs_sh/entities.lua#L239
	---@return number undefined Render group
	function _G.Entity:getRenderGroup() end
	--- getBodygroups - shared - libs_sh/entities.lua#L706
	...
	--- setMaxHealth - server - libs_sh/entities.lua#L1195
	---@param val number New max health value.
	function _G.Entity:setMaxHealth(val) end
	--- setIK - shared - libs_sh/entities.lua#L555
	---@param enabled boolean 
	function _G.Entity:setIK(enabled) end
	--- getGroundEntity - shared - libs_sh/entities.lua#L2299
	---@return Entity undefined Ground entity
	function _G.Entity:getGroundEntity() end
	--- getGravity - shared - libs_sh/entities.lua#L2292
	---@return number undefined The gravity multiplier
	function _G.Entity:getGravity() end
	--- getHitBoxHitGroup - shared - libs_sh/entities.lua#L2100
	...
	--- emitSound - shared - libs_sh/entities.lua#L295
	---@param snd string Sound path
	---@param soundLevel number? Default 75
	---@param pitchPercent number? Default 100
	---@param volume number? Default 1
	...
	---@param dsp number? Default 1 DSP preset
	---@param nofilter boolean? (Optional) Boolean Make the sound play for everyone regardless of range or location. Only affects Server-side sounds.
	function _G.Entity:emitSound(snd, soundLevel, pitchPercent, volume, channel, dsp, nofilter) end
	--- setContents - server - libs_sv/entities.lua#L861
	---@param contents number The CONTENTS enum
	function _G.Entity:setContents(contents) end
	--- lookupBone - shared - libs_sh/entities.lua#L1262
	---@param name string The bone's string name
	---@return number undefined The bone index
	function _G.Entity:lookupBone(name) end
	--- getQuotaMax - shared - libs_sh/entities.lua#L1132
	---@return number undefined Max SysTime allowed to take for execution of the chip in a Think.
	function _G.Entity:getQuotaMax() end
	--- getBoundingRadius - shared - libs_sh/entities.lua#L2232
	...
	--- getSkin - shared - libs_sh/entities.lua#L758
	---@return number undefined Skin number
	function _G.Entity:getSkin() end
	--- getMaterial - shared - libs_sh/entities.lua#L1963
	---@return string undefined String material
	function _G.Entity:getMaterial() end
	--- setLOD - client - libs_sh/entities.lua#L204
	---@param num number The Level Of Detail model ID to use.
	function _G.Entity:setLOD(num) end
	--- setColor4Part - shared - libs_sh/entities.lua#L584
	---@param r number Red 0 - 255
	---@param g number Green 0 - 255
	---@param b number Blue 0 - 255
	---@param a number Alpha 0 - 255
	function _G.Entity:setColor4Part(r, g, b, a) end
	--- getWirelink - server - libs_sv/wire.lua#L796
	---@return Wirelink undefined Wirelink of the entity
	function _G.Entity:getWirelink() end
	--- getSequenceList - shared - libs_sh/entities.lua#L1646
	...
	--- stopSound - shared - libs_sh/entities.lua#L325
	...
	--- getNoDraw - shared - libs_sh/entities.lua#L615
	---@return boolean undefined True if should draw, False otherwise
	function _G.Entity:getNoDraw() end
	--- setupBones - client - libs_sh/entities.lua#L1314
	function _G.Entity:setupBones() end
	--- setRenderBounds - client - libs_sh/entities.lua#L178
	...
	--- setNoDraw - shared - libs_sh/entities.lua#L605
	---@param draw boolean Whether to draw the entity or not.
	function _G.Entity:setNoDraw(draw) end
	--- setLocalPos - server - libs_sv/entities.lua#L585
	---@param vec Vector New position
	function _G.Entity:setLocalPos(vec) end
	--- entIndex - shared - libs_sh/entities.lua#L1220
	---@return number undefined The numerical index of the entity
	function _G.Entity:entIndex() end
	--- getPos - shared - libs_sh/entities.lua#L1241
	---@return Vector undefined The position vector
	function _G.Entity:getPos() end
	--- getManipulateBoneJiggle - shared - libs_sh/entities.lua#L1393
	---@param bone number? Bone index. (def 0)
	---@return number undefined Manipulate jiggle of the bone
	function _G.Entity:getManipulateBoneJiggle(bone) end
	--- setTriggerListener - server - libs_sv/entities.lua#L1158
	---@param startTouchCB function|nil The StartTouch callback function. Arguments: (Entity object), the object entering our entity's bounds.
	---@param endTouchCB function|nil The EndTouch callback function. Arguments: (Entity object), the object leaving our entity's bounds.
	function _G.Entity:setTriggerListener(startTouchCB, endTouchCB) end
	--- setAngleVelocity - server - libs_sv/entities.lua#L380
	---@param angvel Vector The local angvel vector to set
	function _G.Entity:setAngleVelocity(angvel) end
	--- getBoneName - shared - libs_sh/entities.lua#L1335
	---@param bone number? Bone index. (def 0)
	---@return string undefined Name of the bone
	function _G.Entity:getBoneName(bone) end
	--- getChildren - shared - libs_sh/entities.lua#L828
	---@return table undefined Table of parented children
	function _G.Entity:getChildren() end
	--- doNotDuplicate - server - libs_sh/entities.lua#L1205
	---@param allowDupe boolean? Set to true to re-enable duplicating (default false)
	function _G.Entity:doNotDuplicate(allowDupe) end
	--- manipulateBoneScale - shared - libs_sh/entities.lua#L478
	---@param bone number The bone ID
	---@param vec Vector The scale it should be manipulated to
	function _G.Entity:manipulateBoneScale(bone, vec) end
	--- setPos - server - libs_sv/entities.lua#L569
	---@param vec Vector New position
	function _G.Entity:setPos(vec) end
	--- applyAngForce - server - libs_sv/entities.lua#L469
	---@param ang Angle The force angle
	function _G.Entity:applyAngForce(ang) end
	--- setMeshMaterial - client - libs_sh/entities.lua#L126
	...
	--- obbSize - shared - libs_sh/entities.lua#L1420
	---@return Vector undefined The outer bounding box size
	function _G.Entity:obbSize() end
	--- getAllConstrained - server - libs_sv/entities.lua#L991
	...
	---@return table undefined All constrained entities
	function _G.Entity:getAllConstrained(filter) end
	--- getBodygroupCount - shared - libs_sh/entities.lua#L732
	...
	--- setCustomPropForces - server - libs_sv/entities.lua#L303
	...
	--- applyForceOffset - server - libs_sv/entities.lua#L450
	...
	--- manipulateBoneJiggle - shared - libs_sh/entities.lua#L532
	---@param bone number The bone ID
	---@param state boolean Whether to make the bone jiggly or not
	function _G.Entity:manipulateBoneJiggle(bone, state) end
	--- getUnFreezable - server - libs_sv/entities.lua#L916
	---@return boolean undefined unfreezable
	function _G.Entity:getUnFreezable() end
	--- obbMaxs - shared - libs_sh/entities.lua#L1450
	---@return Vector undefined The max bounding box vector
	function _G.Entity:obbMaxs() end
	--- isValid - shared - libs_sh/entities.lua#L1015
	---@return boolean undefined True if valid, false if not
	function _G.Entity:isValid() end
	--- getMass - shared - libs_sh/entities.lua#L1499
	---@return number undefined The numerical mass
	function _G.Entity:getMass() end
	--- getAngleVelocityAngle - shared - libs_sh/entities.lua#L1541
	---@return Angle undefined The angular velocity as an angle
	function _G.Entity:getAngleVelocityAngle() end
	--- setSubMaterial - shared - libs_sh/entities.lua#L640
	---@param index number Submaterial index.
	---@param material string New material name.
	function _G.Entity:setSubMaterial(index, material) end
	--- worldToLocalAngles - shared - libs_sh/entities.lua#L1603
	...
	--- getSequenceName - shared - libs_sh/entities.lua#L1625
	---@param id number The id of the animation
	---@return string undefined The sequence name
	function _G.Entity:getSequenceName(id) end
	--- getQuotaAverage - shared - libs_sh/entities.lua#L1117
	...
	--- setParent - shared - libs_sh/entities.lua#L379
	...
	--- getSkinCount - shared - libs_sh/entities.lua#L765
	---@return number undefined The amount of skins
	function _G.Entity:getSkinCount() end
	--- setPose - shared - libs_sh/entities.lua#L1680
...
---@operator tostring:string
_G.Constraint = {}
	--- remove - server - libs_sv/constraint.lua#L66
	function _G.Constraint:remove() end
	--- doNotDuplicate - server - libs_sv/constraint.lua#L94
	---@param allowDupe boolean? Set to true to re-enable duplicating (default false)
	function _G.Constraint:doNotDuplicate(allowDupe) end
	--- isConstraint - server - libs_sv/constraint.lua#L74
	---@return boolean undefined Whether this is a constraint
...
_G.StringStream = {}
	...
	---@return number undefined Float at this position (32-bit)
	...
	---@return number undefined Double at this position (64-bit)
...
_G.Bass = {}
 ...
 (The table will always have the following keys, filled out based on what is available: "album", "artist", "comment", "genre", "id", "title", "year")
	...
	--- getLength - client - libs_cl/bass.lua#L357
	---@return number undefined Sound length in seconds.
	function _G.Bass:getLength() end
	--- getAverageBitRate - client - libs_cl/bass.lua#L442
	---@return number undefined The average bit rate of the sound.
	function _G.Bass:getAverageBitRate() end
	--- isStopped - client - libs_cl/bass.lua#L550
	---@return boolean undefined True if the sound is stopped.
	function _G.Bass:isStopped() end
	--- getTagsMeta - client - libs_cl/bass.lua#L479
	---@return string undefined The meta information, or nil if no information is available.
	function _G.Bass:getTagsMeta() end
	--- getTagsWMA - client - libs_cl/bass.lua#L507
	---@return table undefined A list of available information in no particular order, or nil if no information is available.
	function _G.Bass:getTagsWMA() end
	--- get3DEnabled - client - libs_cl/bass.lua#L538
	---@return boolean undefined Whether the sound channel is currently in 3D mode.
	function _G.Bass:get3DEnabled() end
	...
	--- isValid - client - libs_cl/bass.lua#L406
	...
	--- getTagsMP4 - client - libs_cl/bass.lua#L486
	---@return table undefined A list of available information in no particular order, or nil if no information is available.
	function _G.Bass:getTagsMP4() end
	--- getFileName - client - libs_cl/bass.lua#L377
	---@return string undefined The file name. This will not be always what you have put into the Bass:loadURL() as first argument.
	function _G.Bass:getFileName() end
	--- getTagsHTTP - client - libs_cl/bass.lua#L463
	---@return table undefined A list of HTTP headers or nil if no information is available.
	function _G.Bass:getTagsHTTP() end
	--- isBlockStreamed - client - libs_cl/bass.lua#L392
	---@return boolean undefined Is the audio stream block streamed or not.
	function _G.Bass:isBlockStreamed() end
	--- setLooping - client - libs_cl/bass.lua#L345
	---@param loop boolean Whether the sound should loop.
	function _G.Bass:setLooping(loop) end
	--- getPitch - client - libs_cl/bass.lua#L299
	---@return number undefined The current pitch of the sound.
	function _G.Bass:getPitch() end
	--- set3DCone - client - libs_cl/bass.lua#L575
	...
	function _G.Bass:set3DCone(innerAngle, outerAngle, outerVolume) end
	--- isPaused - client - libs_cl/bass.lua#L563
	---@return boolean undefined True if the sound is paused.
	function _G.Bass:isPaused() end
	--- getSamplingRate - client - libs_cl/bass.lua#L457
	---@return number undefined The sample rate in Hz. This should always be 44100.
	function _G.Bass:getSamplingRate() end
	--- isStalled - client - libs_cl/bass.lua#L569
	---@return boolean undefined True if the sound is stalled.
	function _G.Bass:isStalled() end
	--- isPlaying - client - libs_cl/bass.lua#L557
	---@return boolean undefined True if the sound is playing.
	function _G.Bass:isPlaying() end
	--- getTagsVendor - client - libs_cl/bass.lua#L500
	---@return string undefined The OGG vendor tag, or nil if no information is available.
	function _G.Bass:getTagsVendor() end
	--- is3D - client - libs_cl/bass.lua#L526
	---@return boolean undefined True if the sound is 3D.
	function _G.Bass:is3D() end
	--- setFade - client - libs_cl/bass.lua#L317
	...
	--- getBufferedTime - client - libs_cl/bass.lua#L448
	---@return number undefined The current buffered time of the stream, in seconds.
	function _G.Bass:getBufferedTime() end
	--- getState - client - libs_cl/bass.lua#L544
	...
	--- getLevels - client - libs_cl/bass.lua#L412
	...
	--- setPan - client - libs_cl/bass.lua#L425
	...
	function _G.Bass:setPan(pan) end
	--- get3DCone - client - libs_cl/bass.lua#L589
	---@return number undefined The angle of the inside projection cone in degrees.
	---@return number undefined The angle of the outside projection cone in degrees.
	---@return number undefined The delta-volume outside the outer projection cone.
	function _G.Bass:get3DCone() end
	--- getFade - client - libs_cl/bass.lua#L335
	...
	--- is2D - client - libs_cl/bass.lua#L520
	---@return boolean undefined True if the sound is 2D.
	function _G.Bass:is2D() end
	--- getTagsOGG - client - libs_cl/bass.lua#L493
	---@return table undefined A list of available information in no particular order, or nil if no information is available. 
	function _G.Bass:getTagsOGG() end
...
_G.Npc = {}
	...
	--- addEntityRelationship - server - libs_sh/npc.lua#L91
...
---@class PhysObj
_G.PhysObj = {}
	--- localToWorld - shared - libs_sh/physobj.lua#L142
	...
	--- setDamping - shared - libs_sh/physobj.lua#L506
 ...
 number MaterialOther - Surface Property ID of the physics obj we came in contact with
	...
	--- getMass - shared - libs_sh/physobj.lua#L107
	---@return number undefined Mass of the physics object
	function _G.PhysObj:getMass() end
	--- enableDrag - shared - libs_sh/physobj.lua#L467
	---@param drag boolean Should the bone have air resistance?
	function _G.PhysObj:enableDrag(drag) end
	--- wake - server - libs_sh/physobj.lua#L543
	function _G.PhysObj:wake() end
	--- localToWorldVector - shared - libs_sh/physobj.lua#L156
	---@param vec Vector The normal vector to transform
	---@return Vector undefined The transformed vector
	function _G.PhysObj:localToWorldVector(vec) end
	--- setVelocityInstantaneous - server - libs_sh/physobj.lua#L254
	---@param vel Vector The velocity that will be set
	function _G.PhysObj:setVelocityInstantaneous(vel) end
	--- addVelocity - server - libs_sh/physobj.lua#L278
	---@param vel Vector The world velocity vector to apply
	function _G.PhysObj:addVelocity(vel) end
	--- getInertia - shared - libs_sh/physobj.lua#L121
	---@return Vector undefined Vector Inertia of the physics object
	function _G.PhysObj:getInertia() end
	--- getVelocityAtPoint - shared - libs_sh/physobj.lua#L91
