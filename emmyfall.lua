...
_G.render.Vertex = {
	...
	--- getAngles - client - libs_cl/render.lua#L536
	...
	--- setRGBA - client - libs_cl/render.lua#L857
	---@param r number Number, red value
	---@param g number Number, green value
	---@param b number Number, blue value
	---@param a number Number, alpha value
	function _G.render.setRGBA(r, g, b, a) end
	--- setFilterMag - client - libs_cl/render.lua#L1186
	...
	--- clearBuffersObeyStencil - client - libs_cl/render.lua#L598
	...
	--- getEyePos - client - libs_cl/render.lua#L528
	...
	--- setLightingMode - client - libs_cl/render.lua#L841
	...
	--- popViewMatrix - client - libs_cl/render.lua#L804
	function _G.render.popViewMatrix() end
	--- overrideBlend - client - libs_cl/render.lua#L1757
	...
	--- draw3DSprite - client - libs_cl/render.lua#L1784
	...
	--- drawTexturedRectRotatedFast - client - libs_cl/render.lua#L1434
	...
	--- getDefaultFont - client - libs_cl/render.lua#L1670
	---@return string undefined Default font
	function _G.render.getDefaultFont() end
	--- setFilterMin - client - libs_cl/render.lua#L1197
	---@param val number The filter function to use http://wiki.facepunch.com/gmod/Enums/TEXFILTER
	function _G.render.setFilterMin(val) end
	--- drawPixelsRGBA - client - libs_cl/render.lua#L1491
	---@param w number Width of image to be drawn.
	---@param h number Height of image to be drawn.
	---@param dataR table Red channel data.
	---@param dataG table Green channel data.
	...
	--- drawText - client - libs_cl/render.lua#L1676
	...
	--- drawRoundedBox - client - libs_cl/render.lua#L1230
	...
	--- depthRange - client - libs_cl/render.lua#L2373
	...
	--- screenShake - client - libs_cl/render.lua#L2364
	...
	--- setMaterial - client - libs_cl/render.lua#L895
	---@param mat Material The material object
	function _G.render.setMaterial(mat) end
	--- enableClipping - client - libs_cl/render.lua#L2193
	...
	--- drawSimpleText - client - libs_cl/render.lua#L1689
	---@param x number X coordinate
	---@param y number Y coordinate
	---@param text string Text to draw
	...
	--- draw3DBox - client - libs_cl/render.lua#L1831
	...
	--- isHUDActive - client - libs_cl/render.lua#L2039
	...
	--- createMaterial - client - libs_cl/render.lua#L868
	...
	--- setFogStart - client - libs_cl/render.lua#L2290
	...
	--- setFogMode - client - libs_cl/render.lua#L2262
	---@param mode number Fog mode
	function _G.render.setFogMode(mode) end
	--- drawRectOutline - client - libs_cl/render.lua#L1291
	...
	--- parseMarkup - client - libs_cl/render.lua#L1705
	...
	--- drawTexturedRectUV - client - libs_cl/render.lua#L1387
	...
	--- computeDynamicLighting - client - libs_cl/render.lua#L2241
	...
	--- getResolution - client - libs_cl/render.lua#L2012
	...
	--- createRenderTarget - client - libs_cl/render.lua#L1069
	---@param name string The name of the render target
	function _G.render.createRenderTarget(name) end
	--- drawTexturedRectRotated - client - libs_cl/render.lua#L1447
	---@param x number X coordinate of center of rect
	---@param y number Y coordinate of center of rect
	---@param w number Width
	---@param h number Height
	...
	--- resetModelLighting - client - libs_cl/render.lua#L589
	...
	--- clear - client - libs_cl/render.lua#L1216
	...
	--- getMatrix - client - libs_cl/render.lua#L743
	---@return VMatrix undefined The currently active matrix.
	function _G.render.getMatrix() end
	--- setModelLighting - client - libs_cl/render.lua#L579
	...
	--- renderView - client - libs_cl/render.lua#L2045
	...
	--- setMaterialEffectColorModify - client - libs_cl/render.lua#L1007
	...
	--- resetStencil - client - libs_cl/render.lua#L678
	function _G.render.resetStencil() end
	--- drawTexturedRect - client - libs_cl/render.lua#L1352
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawTexturedRect(x, y, w, h) end
	--- setScreenDimensions - client - libs_cl/render.lua#L2338
	...
	--- getGameResolution - client - libs_cl/render.lua#L2023
	...
	--- setFont - client - libs_cl/render.lua#L1639
	---@param font string The font to use
	function _G.render.setFont(font) end
	--- setStencilEnable - client - libs_cl/render.lua#L550
	---@param enable boolean True to enable, false to disable
	function _G.render.setStencilEnable(enable) end
	--- cursorPos - client - libs_cl/render.lua#L1921
	...
	--- setBackgroundColor - client - libs_cl/render.lua#L817
	...
	--- setStencilZFailOperation - client - libs_cl/render.lua#L646
	---@param operation number 
	function _G.render.setStencilZFailOperation(operation) end
	--- capturePixels - client - libs_cl/render.lua#L1981
	function _G.render.capturePixels() end
	--- drawTexturedRectFast - client - libs_cl/render.lua#L1341
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawTexturedRectFast(x, y, w, h) end
	--- clearStencilBufferRectangle - client - libs_cl/render.lua#L610
	...
	--- draw3DBeam - client - libs_cl/render.lua#L1861
	...
	--- setMaterialEffectSub - client - libs_cl/render.lua#L934
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	function _G.render.setMaterialEffectSub(mat) end
	--- draw3DQuad - client - libs_cl/render.lua#L1875
	...
	--- drawPixelsSubrectRGB - client - libs_cl/render.lua#L1507
	...
	--- drawPoly - client - libs_cl/render.lua#L1744
	...
	--- captureImage - client - libs_cl/render.lua#L1988
	...
	--- pushViewMatrix - client - libs_cl/render.lua#L758
	...
	--- createFont - client - libs_cl/render.lua#L1565
	...
	--- drawLine - client - libs_cl/render.lua#L1555
	...
	--- getTextSize - client - libs_cl/render.lua#L1630
	...
	--- drawFilledCircle - client - libs_cl/render.lua#L1311
	---@param x number Center x coordinate
	---@param y number Center y coordinate
	---@param r number Radius
	function _G.render.drawFilledCircle(x, y, r) end
	--- disableScissorRect - client - libs_cl/render.lua#L729
	function _G.render.disableScissorRect() end
	--- setMaterialEffectAdd - client - libs_cl/render.lua#L920
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	function _G.render.setMaterialEffectAdd(mat) end
	--- draw3DSphere - client - libs_cl/render.lua#L1794
	---@param pos Vector Position of the sphere
	---@param radius number Radius of the sphere
	---@param longitudeSteps number The amount of longitude steps. The larger this number is, the smoother the sphere is
	---@param latitudeSteps number The amount of latitude steps. The larger this number is, the smoother the sphere is
	function _G.render.draw3DSphere(pos, radius, longitudeSteps, latitudeSteps) end
	--- drawRectFast - client - libs_cl/render.lua#L1268
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawRectFast(x, y, w, h) end
	--- clearDepth - client - libs_cl/render.lua#L1776
	function _G.render.clearDepth() end
	--- drawRect - client - libs_cl/render.lua#L1279
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	function _G.render.drawRect(x, y, w, h) end
	--- popMatrix - client - libs_cl/render.lua#L735
	function _G.render.popMatrix() end
	--- setMaterialEffectBloom - client - libs_cl/render.lua#L948
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- setStencilPassOperation - client - libs_cl/render.lua#L638
	---@param operation number 
	function _G.render.setStencilPassOperation(operation) end
	--- drawBlurEffect - client - libs_cl/render.lua#L1040
	...
	--- enableDepth - client - libs_cl/render.lua#L1750
	---@param enable boolean True to enable
	function _G.render.enableDepth(enable) end
	--- setMaterialEffectDownsample - client - libs_cl/render.lua#L974
	---@param mat Material The material object to use the texture of, or the name of a rendertarget to use instead.
	...
	--- drawTexturedRectUVFast - client - libs_cl/render.lua#L1363
	---@param x number Top left corner x
	---@param y number Top left corner y
	---@param w number Width
	---@param h number Height
	...
	--- clearStencil - client - libs_cl/render.lua#L558
	function _G.render.clearStencil() end
	--- setStencilFailOperation - client - libs_cl/render.lua#L630
	---@param operation number 
	function _G.render.setStencilFailOperation(operation) end
	--- draw3DQuadUV - client - libs_cl/render.lua#L1891
	---@param vert1 Vector First vertex. {x, y, z, u, v}
	---@param vert2 Vector The second vertex.
	---@param vert3 Vector The third vertex.
	---@param vert4 Vector The fourth vertex.
	function _G.render.draw3DQuadUV(vert1, vert2, vert3, vert4) end
	--- selectRenderTarget - client - libs_cl/render.lua#L1098
	---@param name string? Name of the render target to use
	function _G.render.selectRenderTarget(name) end
	--- renderTargetExists - client - libs_cl/render.lua#L1062
	---@param name string The name of the render target
	function _G.render.renderTargetExists(name) end
	--- setStencilWriteMask - client - libs_cl/render.lua#L670
	---@param mask number The mask bitflag.
...
---@class Markup
_G.Markup = {}
	--- getSize - client - libs_cl/render.lua#L1737
	...
	--- draw - client - libs_cl/render.lua#L1713
	...
	--- getWidth - client - libs_cl/render.lua#L1725
	---@return number undefined The width of the object
	function _G.Markup:getWidth() end
	--- getHeight - client - libs_cl/render.lua#L1731
	---@return number undefined The height of the object
